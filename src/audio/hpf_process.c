...
void app_hpf_init(void)
{
    ...
    // Set cutoff (e.g., 35 Hz @ 48 kHz as ÅgDC blocker + subsonicÅh)
                                            ...
                                            float* a1, float* a2)
{
    ...
    // Clamp fc into a sane range: [1 Hz, fs/3] (ïKóvÇ…âûÇ∂Çƒí≤êÆ)
...
//===========================================================
// Process LR4 (with gain) - DF-II-Transposed Å~ 2 stages
//===========================================================
