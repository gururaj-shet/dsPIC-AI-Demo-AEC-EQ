...
int src_upsample_mono(src_up_state_t* state,
                      ...
                      float* output,
                      int in_samples);
# 15 "../src/audio/aec_src.c" 2
# 27 "../src/audio/aec_src.c"
static const float src_lowpass_coeffs[48] = {
...
static const int phase_offset[6] = {
    0, 8, 16, 24, 32, 40
};
