...
# 1 "c:\\program files\\microchip\\xc-dsc\\v3.31\\include\\string.h" 1 3 4
# 23 "c:\\program files\\microchip\\xc-dsc\\v3.31\\include\\string.h" 3 4
# 1 "c:\\program files\\microchip\\xc-dsc\\v3.31\\include\\bits\\alltypes.h" 1 3 4
# 635 "c:\\program files\\microchip\\xc-dsc\\v3.31\\include\\bits\\alltypes.h" 3 4

# 635 "c:\\program files\\microchip\\xc-dsc\\v3.31\\include\\bits\\alltypes.h" 3 4
typedef struct __locale_struct * locale_t;
# 24 "c:\\program files\\microchip\\xc-dsc\\v3.31\\include\\string.h" 2 3 4
...
# 21 "../src/SPI_TDM_drv.c" 2
# 1 "../src/audio/LED_level_meter.h" 1
# 37 "../src/audio/LED_level_meter.h"
extern void level_meter_proc(const float* input, size_t in_buf_ch, size_t frame_samples);
# 22 "../src/SPI_TDM_drv.c" 2
...
# 5 "../src/audio/click_crack_synth.h" 2
...
static int32_t Tx_Data[ 2 * (8) * (32) ] __attribute__((aligned(4)));
static int32_t Rx_Data[ 2 * (8) * (32) ] __attribute__((aligned(4)));

static float f_A_Data[ (2) * (32) ];
...
# 387 "../src/SPI_TDM_drv.c"
    ...
    local_dma_debug_halt( (0), dma_stat );
...
# 400 "../src/SPI_TDM_drv.c"
    ...
    if( dma_tx_addr >= Half_Tx_Addr )
    {
        ...
        dest_ptr = (int32_t*)&Tx_Data[ (0) ];
    }
    else
    {

        dest_ptr = (int32_t*)&Tx_Data[ ((8) * (32)) ];
    }
...
# 434 "../src/SPI_TDM_drv.c"
    ...
    app_widen_process(&f_A_Data[0], &f_A_Data[0]);
    ...
    g_audio_level_out = calc_peak_level_u8( &f_A_Data[0], (32) * (2) );


    wav_to_tdm_float_process( &f_A_Data[0], &f_A_Data[0], (2), (32) );


    convert_tdm_float_to_int32( &f_A_Data[0], (2), dest_ptr, (8), (32) );
    ...
    level_meter_proc( &f_A_Data[0], (2), (32) );



    dma4_pwm5_process(&f_A_Data[0], (2));
    dma5_pwm6_process(&f_A_Data[0], (2));
    dma6_pwm7_process(&f_A_Data[0], (2));
    dma7_pwm8_process(&f_A_Data[0], (2));
...
# 846 "../src/SPI_TDM_drv.c"
    ...
    local_dma_debug_halt( (1), dma_stat );
...
# 962 "../src/SPI_TDM_drv.c"
    ...
    DMA0CHbits.RELOADC = 1;
    DMA0CHbits.RELOADS = 0;
    DMA0CHbits.RELOADD = 1;
...
# 1299 "../src/SPI_TDM_drv.c"
    ...
    SPI1CON1bits.AUDEN = 0;



    SPI1CON1bits.IGNROV = 1;
    SPI1CON1bits.IGNTUR = 1;
    SPI1CON1bits.MSTEN = 0;

    SPI1CON1bits.DISSDI = 0;
...
# 1327 "../src/SPI_TDM_drv.c"
    ...
    SPI1CON1bits.FRMSYNC = 1;

    SPI1CON1bits.FRMEN = 1;
...
static uint8_t calc_peak_level_u8(float* buf, int num_samples)
{
    ...
    {
        sample_abs = buf[i];
        if (sample_abs < 0.0f) sample_abs = -sample_abs;
