...
void wm8731_set_digital_audio_interface_format(uint32_t ul_value)
{
 ...
 wm8731_write_register((0x07u),
   g_us_wm8731_reg_digital_audio_interface_format_value | (0x40));
}
...
void wm8731_set_sampling_ctrl_reg1000( uint32_t ul_value )
{
    ...
    wm8731_write_register((0x08u), g_us_wm8731_reg_sampling_control_value);
}
...
void wm8731_reset(void)
{
 ...
 wm8731_write_register((0x0Fu), (((0x1ffu << 0) & ((0) << 0))));
}
