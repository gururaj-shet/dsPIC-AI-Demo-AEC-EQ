...
# 4 "../src/audio/LED_level_meter.c" 2
...
# 10 "../src/audio/LED_level_meter.c" 2
...
# 11 "../src/audio/LED_level_meter.c" 2
...
float y1f(float);
float ynf(int, float);
# 12 "../src/audio/LED_level_meter.c" 2
...
# 13 "../src/audio/LED_level_meter.c" 2
...
extern void convert_float_to_pwm_20bit( const float* float_in,
                                              ...
                                              uint32_t pwm_period );
# 14 "../src/audio/LED_level_meter.c" 2
...
# 17 "../src/audio/LED_level_meter.c" 2
# 49 "../src/audio/LED_level_meter.c"
static float smoothed_peak = 0.0f;
static float level_accum = 0.0f;
static uint32_t sample_count = 0;
# 61 "../src/audio/LED_level_meter.c"
static const float thresholds[8] =
{
    (powf((10.0f), (-40.0f - (22.0f)) / 20.0f)),
    (powf((10.0f), (-34.0f - (22.0f)) / 20.0f)),
    (powf((10.0f), (-28.0f - (22.0f)) / 20.0f)),
    (powf((10.0f), (-22.0f - (22.0f)) / 20.0f)),
    (powf((10.0f), (-16.0f - (22.0f)) / 20.0f)),
    (powf((10.0f), (-10.0f - (22.0f)) / 20.0f)),
    (powf((10.0f), (-4.0f - (22.0f)) / 20.0f)),
    (powf((10.0f), (-0.9f - (22.0f)) / 20.0f))
};
# 90 "../src/audio/LED_level_meter.c"
void level_meter_proc(const float* input, size_t in_buf_ch, size_t frame_samples)
{
    for (size_t i = 0; i < frame_samples; ++i)
    {
        float l = input[i * in_buf_ch + 0];
        float r = input[i * in_buf_ch + 1];
        float avg = 0.5f * (fabsf(l) + fabsf(r));
    ...
    if (sample_count >= 60)
    {
        float mean_peak = level_accum / (float)sample_count;




        const float attack_coeff = 3.5f;
        const float release_coeff = 0.08f;

        if (mean_peak > smoothed_peak)
        {
            smoothed_peak += attack_coeff * (mean_peak - smoothed_peak);
        }
        else
        {
            smoothed_peak += release_coeff * (mean_peak - smoothed_peak);
        }
