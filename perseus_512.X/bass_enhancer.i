...
# 10 "../src/audio/bass_enhancer.c" 2
...
float y1f(float);
float ynf(int, float);
# 11 "../src/audio/bass_enhancer.c" 2
...
# 13 "../src/audio/bass_enhancer.c" 2
...
# 16 "../src/audio/bass_enhancer.c" 2
# 54 "../src/audio/bass_enhancer.c"
           bassh_t g_bassh;


static biquad_mono_t g_room_bq;
...
# 88 "../src/audio/bass_enhancer.c"
static inline float biquad_process(biquad_mono_t* b, float x)
{
    float y = 
# 90 "../src/audio/bass_enhancer.c" 3 4
               fmaf
# 90 "../src/audio/bass_enhancer.c"
                  ( b->bq.b0, x, b->bqs.z1 );
    b->bqs.z1 = 
# 91 "../src/audio/bass_enhancer.c" 3 4
               fmaf
# 91 "../src/audio/bass_enhancer.c"
                  ( b->bq.b1, x, 
# 91 "../src/audio/bass_enhancer.c" 3 4
                                 fmaf
# 91 "../src/audio/bass_enhancer.c"
                                    (-b->bq.a1, y, b->bqs.z2) );
    b->bqs.z2 = 
# 92 "../src/audio/bass_enhancer.c" 3 4
               fmaf
# 92 "../src/audio/bass_enhancer.c"
                  ( b->bq.b2, x, -b->bq.a2*y );
    return y;
}
# 109 "../src/audio/bass_enhancer.c"
static void biquad_make_lpf(biquad_mono_t* b, float fs, float fc, float Q)
{
    float w0 = 2.0f*(float)
# 111 "../src/audio/bass_enhancer.c" 3 4
                          3.14159265358979323846
# 111 "../src/audio/bass_enhancer.c"
                              *fc/fs;
    float c = 
# 112 "../src/audio/bass_enhancer.c" 3 4
              __builtin_cosf
# 112 "../src/audio/bass_enhancer.c"
                  (w0);
    float s = 
# 113 "../src/audio/bass_enhancer.c" 3 4
              __builtin_sinf
# 113 "../src/audio/bass_enhancer.c"
                  (w0);
...
{
    float w0 = 2.0f*(float)
# 133 "../src/audio/bass_enhancer.c" 3 4
                          3.14159265358979323846
# 133 "../src/audio/bass_enhancer.c"
                              *fc/fs;
    float c = 
# 134 "../src/audio/bass_enhancer.c" 3 4
              __builtin_cosf
# 134 "../src/audio/bass_enhancer.c"
                  (w0);
    float s = 
# 135 "../src/audio/bass_enhancer.c" 3 4
              __builtin_sinf
# 135 "../src/audio/bass_enhancer.c"
                  (w0);
    float alpha = s/(2.0f*Q);
    float b0 = (1.0f + c)*0.5f;
    float b1 = -(1.0f + c);
...
static void bassh_rebuild(bassh_t* sh)
{
    ...
    sh->loud_aA = expf(-1.0f / (0.010f * fs));
    sh->loud_aR = expf(-1.0f / (0.200f * fs));
    ...
    if(sh->p.bloom_enabled)
    {
        ...
        if (sh->bloom_D >= 2048) sh->bloom_D = 2048 -1;
...

    {
        ...
        float w0 = 2.0f*(float)
# 242 "../src/audio/bass_enhancer.c" 3 4
                              3.14159265358979323846 
# 242 "../src/audio/bass_enhancer.c"
                                   * f0 / fs;
        float c = 
# 243 "../src/audio/bass_enhancer.c" 3 4
                  __builtin_cosf
# 243 "../src/audio/bass_enhancer.c"
                      (w0);
        float s = 
# 244 "../src/audio/bass_enhancer.c" 3 4
                  __builtin_sinf
# 244 "../src/audio/bass_enhancer.c"
                      (w0);
        float alpha = s/(2.0f*Q);
...
void bassh_set_default_params(bassh_t* sh)
{
    ...
    params->enabled = 
# 281 "../src/audio/bass_enhancer.c" 3 4
                             0
# 281 "../src/audio/bass_enhancer.c"
                                  ;
    ...
    params->dc_hpf_hz = 26.0f;

    params->bloom_enabled = 
# 293 "../src/audio/bass_enhancer.c" 3 4
                             1
# 293 "../src/audio/bass_enhancer.c"
                                 ;
    params->bloom_time_ms = 28.0f;
    params->bloom_delay_ms = 12.0f;
    ...
    params->tune.lpf_cap_db = 18.0f;
    params->tune.lpf_cap_quiet_bonus_db = 0.0f;
    params->tune.lpf_base_db = 12.0f;
    params->tune.env_floor_lpf = 0.12f;
    params->tune.duck_lpf_coef = 0.60f;
...
void bassh_process(bassh_t* sh, const float* in, float* out, int frames )
{
    ...
    const float aUp = expf(-1.0f / (sh->p.loud.atk_ms * 0.001f * fs_boost));
    const float aDown = expf(-1.0f / (sh->p.loud.rel_ms * 0.001f * fs_boost));
    ...
    float lpf_bonus_db = 20.0f * log10f(fmaxf(sh->loud_gain_lin, (1.0e-7f)));
    if (lpf_bonus_db < 0.0f) lpf_bonus_db = 0.0f;


    const float L_wide_db = 20.0f * log10f(fmaxf(sh->loud_env_wide, (1.0e-7f)));
    float t = (L_wide_db - sh->p.loud.L_hi_dbfs) / (sh->p.loud.L_lo_dbfs - sh->p.loud.L_hi_dbfs);
    if (t < 0.0f) t = 0.0f;
    else if (t > 1.0f) t = 1.0f;

    float quiet01 = t*t*(3.0f - 2.0f*t);
    ...
    float gain_lpf = powf(10.0f, lpf_gain_db / 20.0f);
...
# 417 "../src/audio/bass_enhancer.c"
        ...
        if (sh->p.loud.enabled)
        {
            ...
            const float dt = 1.0f / fs_boost;
            float diff_dB = desire_dB - sh->loud_bonus_dB_slow;


            if (diff_dB > 0.25f) diff_dB -= 0.25f;
            else if (diff_dB < -0.25f) diff_dB += 0.25f;
            else diff_dB = 0.0f;


            const float max_up_dB = 8.0f * dt;
            const float max_dn_dB = 12.0f * dt;
        ...
        const float L_wide_db2 = 20.0f * log10f(fmaxf(sh->loud_env_wide, (1.0e-7f)));
        ...
        const float quiet = tq*tq*(3.0f - 2.0f*tq);


        const float floor_dyn = env_floor_lpf * (0.2f + 0.8f * quiet);
...
# 802 "../src/audio/bass_enhancer.c"
void app_bassh_init(void)
{
    bassh_init(&g_bassh, (2), (48000) );
...
void app_bassh_enable(
# 810 "../src/audio/bass_enhancer.c" 3 4
                     _Bool 
# 810 "../src/audio/bass_enhancer.c"
                          en)
{
...
# 827 "../src/audio/bass_enhancer.c" 3 4
_Bool 
# 827 "../src/audio/bass_enhancer.c"
    app_bassh_is_enabled(void)
{
...
void app_bassh_preset_speaker_A(bassh_t* sh)
{
    ...
    params->limiter_thresh = 0.95f;
    params->dc_hpf_hz = 28.0f;

    params->bloom_enabled = 
# 852 "../src/audio/bass_enhancer.c" 3 4
                             1
# 852 "../src/audio/bass_enhancer.c"
                                 ;
    params->bloom_delay_ms = 20.0f;
    params->bloom_time_ms = 900.0f;
    params->bloom_mix = 0.95f;
    params->bloom_duck = 0.00f;


    params->tune.env_floor_lpf = 0.36f;
    params->tune.duck_lpf_coef = 0.45f;

    params->tune.lpf_cap_db = 18.0f;
    params->tune.lpf_cap_quiet_bonus_db = 12.0f;
    params->tune.lpf_base_db = 12.0f;


    params->tune.exc_target = 0.26f;
    params->tune.exc_attack_ms = 2.2f;
    params->tune.exc_release_ms = 220.0f;




    params->loud.enabled = 
# 874 "../src/audio/bass_enhancer.c" 3 4
                            1
# 874 "../src/audio/bass_enhancer.c"
                                ;

    params->loud.Bmax_dB = 7.0f;
    params->loud.alpha = 1.0f;
    params->loud.beta = 1.0f;


    params->loud.L_hi_dbfs = -25.0f;
    params->loud.L_lo_dbfs = -65.0f;
...
void app_bassh_process(const float* in, float* out)
{
    bassh_process(&g_bassh, in, out, (32));
}
