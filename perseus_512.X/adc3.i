...
static int32_t Iadc3_Data[ (2) * (32) ] __attribute__((aligned(4)));
extern int _CompileAssert[((((2) * (32))/2) == ((sizeof(Iadc3_Data) / sizeof((Iadc3_Data)[0]))/2))?1:-1];


static int32_t Iadc34_Data[ (2) * (2) * (32) ];
...
void ADC3_Cpy_Tdm_Style(uint32_t tdm_pos, uint8_t ch_out, uint8_t ch_pos, int32_t* raw_in )
{
    ...
    for(uint16_t smpl=0; smpl < (32); smpl++)
    {
...
{
    const uint32_t Half_Addr = (uint32_t)&Iadc3_Data[ (((2) * (32))/2) ];
...
# 89 "../src/adc/adc3.c"
    ...
    if( dma_addr >= Half_Addr )
    {
        ...
        int_in = &Iadc34_Data[ (0) ];
    }
    else
    {

        int_in = &Iadc34_Data[ (((2) * (2) * (32))/2) ];
    }
    ...
    for( uint16_t idx=0; idx<(32); idx++ )
    {
        ...
        float x0 = (float)int_in[(2)*idx + 0] * (1.0f / (float)(1u << (16 - 1)));
        float x1 = (float)int_in[(2)*idx + 1] * (1.0f / (float)(1u << (16 - 1)));

        float_out[ (2)*idx +0 ] = x0;
        float_out[ (2)*idx +1 ] = x1;
    }
}
...
# 173 "../src/adc/adc3.c" 3 4
   IFS2bits.DMA2IF 
# 173 "../src/adc/adc3.c"
            = 0;
    dma_stat = 
# 174 "../src/adc/adc3.c" 3 4
              DMA2STAT
# 174 "../src/adc/adc3.c"
                      ;
    
# 175 "../src/adc/adc3.c" 3 4
   DMA2STAT 
# 175 "../src/adc/adc3.c"
            = 0;
    ...
    (
# 181 "../src/adc/adc3.c" 3 4
   LATEbits.LATE4 
# 181 "../src/adc/adc3.c"
   ^= 1);
    (
# 182 "../src/adc/adc3.c" 3 4
   LATHbits.LATH0 
# 182 "../src/adc/adc3.c"
   ^= 1);
...
# 195 "../src/adc/adc3.c"
    ...
    ADC3_Cpy_Tdm_Style( idx_tdm, (2), 0 , &Iadc3_Data[idx_adc] );
}
# 223 "../src/adc/adc3.c"
static void dma2_config(void)
{
...
# 233 "../src/adc/adc3.c" 3 4
   DMA2DST 
# 233 "../src/adc/adc3.c"
           = (uint32_t)&Iadc3_Data;
    
# 234 "../src/adc/adc3.c" 3 4
   DMA2CNT 
# 234 "../src/adc/adc3.c"
           = (sizeof(Iadc3_Data) / sizeof((Iadc3_Data)[0]));
...
# 263 "../src/adc/adc3.c" 3 4
   IPC9bits.DMA2IP 
# 263 "../src/adc/adc3.c"
           = 4;
    
# 264 "../src/adc/adc3.c" 3 4
   IFS2bits.DMA2IF 
# 264 "../src/adc/adc3.c"
           = 0;
    
# 265 "../src/adc/adc3.c" 3 4
   IEC2bits.DMA2IE 
# 265 "../src/adc/adc3.c"
           = 1;
...
# 291 "../src/adc/adc3.c" 3 4
   AD3CON 
# 291 "../src/adc/adc3.c"
               = 0x0UL;
    
# 292 "../src/adc/adc3.c" 3 4
   AD3DATAOVR 
# 292 "../src/adc/adc3.c"
               = 0x0UL;
    
# 293 "../src/adc/adc3.c" 3 4
   AD3STAT 
# 293 "../src/adc/adc3.c"
               = 0x0UL;
    
# 294 "../src/adc/adc3.c" 3 4
   AD3RSTAT 
# 294 "../src/adc/adc3.c"
               = 0x0UL;
    
# 295 "../src/adc/adc3.c" 3 4
   AD3CMPSTAT 
# 295 "../src/adc/adc3.c"
               = 0x0UL;
    
# 296 "../src/adc/adc3.c" 3 4
   AD3SWTRG 
# 296 "../src/adc/adc3.c"
               = 0x0UL;
...
# 300 "../src/adc/adc3.c" 3 4
   RPINR23bits.ADTRG31R 
# 300 "../src/adc/adc3.c"
             = 70;

    (
# 302 "../src/adc/adc3.c" 3 4
   ANSELA 
# 302 "../src/adc/adc3.c"
   |= (1u << (6)));
    (
# 303 "../src/adc/adc3.c" 3 4
   TRISAbits.TRISA6 
# 303 "../src/adc/adc3.c"
   = 1);
    AD3CH0CON1bits.PINSEL = 2;


    AD3CH0CON1bits.DIFF = 0;
    AD3CH0CON1bits.NINSEL = 0;
    AD3CH0CON1bits.FRAC = 0;
    AD3CH0CON1bits.TRG1POL = 0;
    AD3CH0CON1bits.EIEN = 0;
    AD3CH0CON1bits.IRQSEL = 1;
    AD3CH0CON1bits.SAMC = 0;
    AD3CH0CON1bits.ACCNUM = 3;
    AD3CH0CON1bits.MODE = 3;
    AD3CH0CON1bits.TRG1SRC = 0b011111;


    AD3CH0CON1bits.TRG2SRC = 0;
# 328 "../src/adc/adc3.c"
    AD3CH0CON2bits.ACCRO = 0;
    AD3CH0CON2bits.ACCBRST = 1;
    AD3CH0CON2bits.CMPVAL = 1;
    AD3CH0CON2bits.CMPCNTMOD = 0;

    AD3CH0CON2bits.CMPMOD = 0;
    AD3CH0CON2bits.ADCMPCNT = 0;





    AD3CONbits.ACALEN = 0x0UL;
...
# 356 "../src/adc/adc3.c" 3 4
   IFS6bits.AD3CH0IF 
# 356 "../src/adc/adc3.c"
             = 0;
    
# 357 "../src/adc/adc3.c" 3 4
   IEC6bits.AD3CH0IE 
# 357 "../src/adc/adc3.c"
             = 0;
...
# 364 "../src/adc/adc3.c" 3 4
   AD3CON 
# 364 "../src/adc/adc3.c"
               = 0x0UL;
    
# 365 "../src/adc/adc3.c" 3 4
   AD3DATAOVR 
# 365 "../src/adc/adc3.c"
               = 0x0UL;
    
# 366 "../src/adc/adc3.c" 3 4
   AD3STAT 
# 366 "../src/adc/adc3.c"
               = 0x0UL;
    
# 367 "../src/adc/adc3.c" 3 4
   AD3RSTAT 
# 367 "../src/adc/adc3.c"
               = 0x0UL;
    
# 368 "../src/adc/adc3.c" 3 4
   AD3CMPSTAT 
# 368 "../src/adc/adc3.c"
               = 0x0UL;
    
# 369 "../src/adc/adc3.c" 3 4
   AD3SWTRG 
# 369 "../src/adc/adc3.c"
               = 0x0UL;

    
# 371 "../src/adc/adc3.c" 3 4
   AD3CH0CON1 
# 371 "../src/adc/adc3.c"
               = 0x0UL;
    
# 372 "../src/adc/adc3.c" 3 4
   AD3CH1CON1 
# 372 "../src/adc/adc3.c"
               = 0x0UL;
    
# 373 "../src/adc/adc3.c" 3 4
   AD3CH2CON1 
# 373 "../src/adc/adc3.c"
               = 0x0UL;
    
# 374 "../src/adc/adc3.c" 3 4
   AD3CH3CON1 
# 374 "../src/adc/adc3.c"
               = 0x0UL;
    
# 375 "../src/adc/adc3.c" 3 4
   AD3CH4CON1 
# 375 "../src/adc/adc3.c"
               = 0x0UL;
    
# 376 "../src/adc/adc3.c" 3 4
   AD3CH5CON1 
# 376 "../src/adc/adc3.c"
               = 0x0UL;
    
# 377 "../src/adc/adc3.c" 3 4
   AD3CH6CON1 
# 377 "../src/adc/adc3.c"
               = 0x0UL;
    
# 378 "../src/adc/adc3.c" 3 4
   AD3CH7CON1 
# 378 "../src/adc/adc3.c"
               = 0x0UL;

    
# 380 "../src/adc/adc3.c" 3 4
   AD3CH0CON2 
# 380 "../src/adc/adc3.c"
               = 0x0UL;
    
# 381 "../src/adc/adc3.c" 3 4
   AD3CH1CON2 
# 381 "../src/adc/adc3.c"
               = 0x0UL;
    
# 382 "../src/adc/adc3.c" 3 4
   AD3CH2CON2 
# 382 "../src/adc/adc3.c"
               = 0x0UL;
    
# 383 "../src/adc/adc3.c" 3 4
   AD3CH3CON2 
# 383 "../src/adc/adc3.c"
               = 0x0UL;
    
# 384 "../src/adc/adc3.c" 3 4
   AD3CH4CON2 
# 384 "../src/adc/adc3.c"
               = 0x0UL;
    
# 385 "../src/adc/adc3.c" 3 4
   AD3CH5CON2 
# 385 "../src/adc/adc3.c"
               = 0x0UL;
    
# 386 "../src/adc/adc3.c" 3 4
   AD3CH6CON2 
# 386 "../src/adc/adc3.c"
               = 0x0UL;
    
# 387 "../src/adc/adc3.c" 3 4
   AD3CH7CON2 
# 387 "../src/adc/adc3.c"
               = 0x0UL;

    
# 389 "../src/adc/adc3.c" 3 4
   AD3CH0RES 
# 389 "../src/adc/adc3.c"
               = 0x0UL;
    
# 390 "../src/adc/adc3.c" 3 4
   AD3CH1RES 
# 390 "../src/adc/adc3.c"
               = 0x0UL;
    
# 391 "../src/adc/adc3.c" 3 4
   AD3CH2RES 
# 391 "../src/adc/adc3.c"
               = 0x0UL;
    
# 392 "../src/adc/adc3.c" 3 4
   AD3CH3RES 
# 392 "../src/adc/adc3.c"
               = 0x0UL;
    
# 393 "../src/adc/adc3.c" 3 4
   AD3CH4RES 
# 393 "../src/adc/adc3.c"
               = 0x0UL;
    
# 394 "../src/adc/adc3.c" 3 4
   AD3CH5RES 
# 394 "../src/adc/adc3.c"
               = 0x0UL;
    
# 395 "../src/adc/adc3.c" 3 4
   AD3CH6RES 
# 395 "../src/adc/adc3.c"
               = 0x0UL;
    
# 396 "../src/adc/adc3.c" 3 4
   AD3CH7RES 
# 396 "../src/adc/adc3.c"
               = 0x0UL;

    
# 398 "../src/adc/adc3.c" 3 4
   AD3CH0CNT 
# 398 "../src/adc/adc3.c"
               = 0x0UL;
    
# 399 "../src/adc/adc3.c" 3 4
   AD3CH1CNT 
# 399 "../src/adc/adc3.c"
               = 0x0UL;
    
# 400 "../src/adc/adc3.c" 3 4
   AD3CH2CNT 
# 400 "../src/adc/adc3.c"
               = 0x0UL;
    
# 401 "../src/adc/adc3.c" 3 4
   AD3CH3CNT 
# 401 "../src/adc/adc3.c"
               = 0x0UL;
    
# 402 "../src/adc/adc3.c" 3 4
   AD3CH4CNT 
# 402 "../src/adc/adc3.c"
               = 0x0UL;
    
# 403 "../src/adc/adc3.c" 3 4
   AD3CH5CNT 
# 403 "../src/adc/adc3.c"
               = 0x0UL;
    
# 404 "../src/adc/adc3.c" 3 4
   AD3CH6CNT 
# 404 "../src/adc/adc3.c"
               = 0x0UL;
    
# 405 "../src/adc/adc3.c" 3 4
   AD3CH7CNT 
# 405 "../src/adc/adc3.c"
               = 0x0UL;

    
# 407 "../src/adc/adc3.c" 3 4
   AD3CH0CMPLO 
# 407 "../src/adc/adc3.c"
               = 0x0UL;
    
# 408 "../src/adc/adc3.c" 3 4
   AD3CH1CMPLO 
# 408 "../src/adc/adc3.c"
               = 0x0UL;
    
# 409 "../src/adc/adc3.c" 3 4
   AD3CH2CMPLO 
# 409 "../src/adc/adc3.c"
               = 0x0UL;
    
# 410 "../src/adc/adc3.c" 3 4
   AD3CH3CMPLO 
# 410 "../src/adc/adc3.c"
               = 0x0UL;
    
# 411 "../src/adc/adc3.c" 3 4
   AD3CH4CMPLO 
# 411 "../src/adc/adc3.c"
               = 0x0UL;
    
# 412 "../src/adc/adc3.c" 3 4
   AD3CH5CMPLO 
# 412 "../src/adc/adc3.c"
               = 0x0UL;
    
# 413 "../src/adc/adc3.c" 3 4
   AD3CH6CMPLO 
# 413 "../src/adc/adc3.c"
               = 0x0UL;
    
# 414 "../src/adc/adc3.c" 3 4
   AD3CH7CMPLO 
# 414 "../src/adc/adc3.c"
               = 0x0UL;

    
# 416 "../src/adc/adc3.c" 3 4
   AD3CH0CMPHI 
# 416 "../src/adc/adc3.c"
               = 0x0UL;
    
# 417 "../src/adc/adc3.c" 3 4
   AD3CH1CMPHI 
# 417 "../src/adc/adc3.c"
               = 0x0UL;
    
# 418 "../src/adc/adc3.c" 3 4
   AD3CH2CMPHI 
# 418 "../src/adc/adc3.c"
               = 0x0UL;
    
# 419 "../src/adc/adc3.c" 3 4
   AD3CH3CMPHI 
# 419 "../src/adc/adc3.c"
               = 0x0UL;
    
# 420 "../src/adc/adc3.c" 3 4
   AD3CH4CMPHI 
# 420 "../src/adc/adc3.c"
               = 0x0UL;
    
# 421 "../src/adc/adc3.c" 3 4
   AD3CH5CMPHI 
# 421 "../src/adc/adc3.c"
               = 0x0UL;
    
# 422 "../src/adc/adc3.c" 3 4
   AD3CH6CMPHI 
# 422 "../src/adc/adc3.c"
               = 0x0UL;
    
# 423 "../src/adc/adc3.c" 3 4
   AD3CH7CMPHI 
# 423 "../src/adc/adc3.c"
               = 0x0UL;
}
