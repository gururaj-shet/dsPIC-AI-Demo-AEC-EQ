...
set(Perseus_512_dsPIC33AK128_dsPIC33AK128_XC_DSC_FILE_TYPE_assemble
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../eq_api_33AK.s"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../eq_perseus_wrapper.s")
set_source_files_properties(${Perseus_512_dsPIC33AK128_dsPIC33AK128_XC_DSC_FILE_TYPE_assemble} PROPERTIES LANGUAGE ASM)

# For assembly files, add "." to the include path for each file so that .include with a relative path works
foreach(source_file ${Perseus_512_dsPIC33AK128_dsPIC33AK128_XC_DSC_FILE_TYPE_assemble})
        set_source_files_properties(${source_file} PROPERTIES INCLUDE_DIRECTORIES "$<PATH:NORMAL_PATH,$<PATH:REMOVE_FILENAME,${source_file}>>")
endforeach()

set(Perseus_512_dsPIC33AK128_dsPIC33AK128_XC_DSC_FILE_TYPE_assemblePreproc)
set_source_files_properties(${Perseus_512_dsPIC33AK128_dsPIC33AK128_XC_DSC_FILE_TYPE_assemblePreproc} PROPERTIES LANGUAGE ASM)

# For assembly files, add "." to the include path for each file so that .include with a relative path works
foreach(source_file ${Perseus_512_dsPIC33AK128_dsPIC33AK128_XC_DSC_FILE_TYPE_assemblePreproc})
        set_source_files_properties(${source_file} PROPERTIES INCLUDE_DIRECTORIES "$<PATH:NORMAL_PATH,$<PATH:REMOVE_FILENAME,${source_file}>>")
endforeach()

set(Perseus_512_dsPIC33AK128_dsPIC33AK128_XC_DSC_FILE_TYPE_compile
...
set_source_files_properties(${Perseus_512_dsPIC33AK128_dsPIC33AK128_XC_DSC_FILE_TYPE_compile} PROPERTIES LANGUAGE C)
set(Perseus_512_dsPIC33AK128_dsPIC33AK128_XC_DSC_FILE_TYPE_compile_cpp)
set_source_files_properties(${Perseus_512_dsPIC33AK128_dsPIC33AK128_XC_DSC_FILE_TYPE_compile_cpp} PROPERTIES LANGUAGE CXX)
set(Perseus_512_dsPIC33AK128_dsPIC33AK128_XC_DSC_FILE_TYPE_link
...
set(Perseus_512_dsPIC33AK128_dsPIC33AK128_XC_DSC_FILE_TYPE_bin2hex)
set(Perseus_512_dsPIC33AK128_image_name "dsPIC33AK128.elf")
set(Perseus_512_dsPIC33AK128_image_base_name "dsPIC33AK128")

# The output directory of the final image.
set(Perseus_512_dsPIC33AK128_output_dir "${CMAKE_CURRENT_SOURCE_DIR}/../../../out/Perseus_512")

# The full path to the final image.
set(Perseus_512_dsPIC33AK128_full_path_to_image ${Perseus_512_dsPIC33AK128_output_dir}/${Perseus_512_dsPIC33AK128_image_name})
