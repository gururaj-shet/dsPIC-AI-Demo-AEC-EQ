...
# 14 "../src/main.c" 2
# 1 "../src/uart/uart1.h" 1
# 44 "../src/uart/uart1.h"
# 1 "../src/uart/uart_interface.h" 1
# 44 "../src/uart/uart_interface.h"
# 1 "../src/uart/uart_types.h" 1
# 45 "../src/uart/uart_types.h"
...
# 45 "../src/uart/uart_interface.h" 2
# 53 "../src/uart/uart_interface.h"
...
# 66 "../src/uart/uart_interface.h" 3 4
   _Bool 
# 66 "../src/uart/uart_interface.h"
        (*IsRxReady)(void);


    
# 69 "../src/uart/uart_interface.h" 3 4
   _Bool 
# 69 "../src/uart/uart_interface.h"
        (*IsTxReady)(void);


    
# 72 "../src/uart/uart_interface.h" 3 4
   _Bool 
# 72 "../src/uart/uart_interface.h"
        (*IsTxDone)(void);
    ...
    void (*AutoBaudSet)(
# 87 "../src/uart/uart_interface.h" 3 4
                       _Bool 
# 87 "../src/uart/uart_interface.h"
                            enable);


    
# 90 "../src/uart/uart_interface.h" 3 4
   _Bool 
# 90 "../src/uart/uart_interface.h"
        (*AutoBaudQuery)(void);


    
# 93 "../src/uart/uart_interface.h" 3 4
   _Bool 
# 93 "../src/uart/uart_interface.h"
        (*AutoBaudEventEnableGet)(void);
...
# 189 "../src/uart/uart1.h"
uint8_t UART1_Read(void);
# 200 "../src/uart/uart1.h"
void UART1_Write(uint8_t data);
# 209 "../src/uart/uart1.h"

# 209 "../src/uart/uart1.h" 3 4
_Bool 
# 209 "../src/uart/uart1.h"
    UART1_IsRxReady(void);
# 218 "../src/uart/uart1.h"

# 218 "../src/uart/uart1.h" 3 4
_Bool 
# 218 "../src/uart/uart1.h"
    UART1_IsTxReady(void);
# 227 "../src/uart/uart1.h"

# 227 "../src/uart/uart1.h" 3 4
_Bool 
# 227 "../src/uart/uart1.h"
    UART1_IsTxDone(void);
...
# 252 "../src/uart/uart1.h"
void UART1_AutoBaudSet(
# 252 "../src/uart/uart1.h" 3 4
                      _Bool 
# 252 "../src/uart/uart1.h"
                           enable);
# 261 "../src/uart/uart1.h"

# 261 "../src/uart/uart1.h" 3 4
_Bool 
# 261 "../src/uart/uart1.h"
    UART1_AutoBaudQuery(void);
# 270 "../src/uart/uart1.h"

# 270 "../src/uart/uart1.h" 3 4
_Bool 
# 270 "../src/uart/uart1.h"
    UART1_AutoBaudEventEnableGet(void);
# 279 "../src/uart/uart1.h"
...
# 53 "../src/i2c.h" 3 4
      _Bool 
# 53 "../src/i2c.h"
              I2Cx_Start(uint8_t inst);
extern void I2Cx_Stop(uint8_t inst);
extern void I2Cx_SendACK(uint8_t inst, 
# 55 "../src/i2c.h" 3 4
                                         _Bool 
# 55 "../src/i2c.h"
                                              ack);
...
# 56 "../src/i2c.h" 3 4
      _Bool 
# 56 "../src/i2c.h"
              I2Cx_WriteByte(uint8_t inst, uint8_t data);
extern uint8_t I2Cx_ReadByte(uint8_t inst, 
# 57 "../src/i2c.h" 3 4
                                          _Bool 
# 57 "../src/i2c.h"
                                               ack);
...
void wm8731_set_sampling_ctrl_reg1000( uint32_t ul_value );
...
# 18 "../src/main.c" 2
# 1 "../src/eq_lib/eq_api_33AK.h" 1
# 71 "../src/eq_lib/eq_api_33AK.h"
typedef enum {
    EQ_BAND_32HZ = 0,
    EQ_BAND_62HZ = 1,
    EQ_BAND_125HZ = 2,
...
typedef struct {
    ...
    eq_biquad_coeffs_t coeffs[8];


    eq_biquad_state_t state[8];


    eq_band_params_t band_params[8];
...
# 266 "../src/eq_lib/eq_api_33AK.h"
void EQ_Enable(eq_instance_t *eq, 
# 266 "../src/eq_lib/eq_api_33AK.h" 3 4
                                 _Bool 
# 266 "../src/eq_lib/eq_api_33AK.h"
                                      enable);
...
# 274 "../src/eq_lib/eq_api_33AK.h" 3 4
_Bool 
# 274 "../src/eq_lib/eq_api_33AK.h"
    EQ_IsEnabled(eq_instance_t *eq);
# 283 "../src/eq_lib/eq_api_33AK.h"
void EQ_Reset(eq_instance_t *eq);
# 296 "../src/eq_lib/eq_api_33AK.h"
void EQ_SetBandParams(eq_instance_t *eq, int band, float center_freq,
                      float bandwidth_oct, float gain_dB);
# 313 "../src/eq_lib/eq_api_33AK.h"
void EQ_ProcessQ15(eq_instance_t *eq, int16_t *samples, int num_samples);
# 324 "../src/eq_lib/eq_api_33AK.h"
...
# 1 "../src/debug/dbconsole.h" 1
# 23 "../src/debug/dbconsole.h"
typedef uint8_t dbc_status_t;
# 36 "../src/debug/dbconsole.h"
typedef struct dbc_msg_s {
    ...
    dbc_status_t status;
    uint16_t raw_len;
    uint8_t data[((((384u)) > 4u) ? ((((384u)) - 4u) / 2u) : 0u)];
    uint16_t data_len;
} dbc_msg_t;
...
# 50 "../src/debug/dbconsole.h" 3 4
_Bool 
# 50 "../src/debug/dbconsole.h"
      dbc_feed_char(uint8_t ch);
...
# 21 "../src/main.c" 2
# 1 "../src/debug/app_debug.h" 1
# 30 "../src/debug/app_debug.h"
extern void app_uart_rx_available(void);
extern void app_onmsg(dbc_msg_t* msg);
# 22 "../src/main.c" 2
# 1 "../src/curiosity/button_led.h" 1
# 32 "../src/curiosity/button_led.h"
extern void BUTTON_Init( void );
extern 
# 33 "../src/curiosity/button_led.h" 3 4
      _Bool 
# 33 "../src/curiosity/button_led.h"
             BUTTON_IsPressed( uint8_t id );
extern 
# 34 "../src/curiosity/button_led.h" 3 4
      _Bool 
# 34 "../src/curiosity/button_led.h"
             BUTTON_DetectReleased( uint8_t id );

extern 
# 36 "../src/curiosity/button_led.h" 3 4
      _Bool 
# 36 "../src/curiosity/button_led.h"
             TOUCH_IsPressed( uint8_t id );
extern 
# 37 "../src/curiosity/button_led.h" 3 4
      _Bool 
# 37 "../src/curiosity/button_led.h"
             TOUCH_DetectReleased( uint8_t id );
...
# 24 "../src/main.c" 2
# 1 "../src/curiosity/pot.h" 1
# 33 "../src/curiosity/pot.h"
...
# 1 "../src/adc/adc5.h" 1
# 26 "../src/adc/adc5.h"
# 1 "../src/adc/adc_types.h" 1
# 33 "../src/adc/adc_types.h"
enum ADC_DEDICATED_CORE
{
    ADC_MAX_DEDICATED_CORES = 0
};
...
# 27 "../src/adc/adc5.h" 2
# 1 "../src/adc/adc_interface.h" 1
# 35 "../src/adc/adc_interface.h"
...
# 82 "../src/adc/adc_interface.h" 3 4
   _Bool 
# 82 "../src/adc/adc_interface.h"
        (*IsConversionComplete)(const unsigned channel);
...
# 262 "../src/adc/adc5.h"
inline static 
# 262 "../src/adc/adc5.h" 3 4
             _Bool 
# 262 "../src/adc/adc5.h"
                  ADC5_IsConversionComplete(const enum ADC5_CHANNEL channel)
{
    
# 264 "../src/adc/adc5.h" 3 4
   _Bool 
# 264 "../src/adc/adc5.h"
        status = 
# 264 "../src/adc/adc5.h" 3 4
...
extern void convert_float_to_pwm_20bit( const float* float_in,
                                              ...
                                              uint32_t pwm_period );
# 35 "../src/main.c" 2
# 1 "../src/audio/gain_ctrl.h" 1
# 21 "../src/audio/gain_ctrl.h"
typedef enum
{
    RAMP_IDLE = 0,
    RAMPING_UP,
...
typedef struct
{
    ...
    float snapThresh;
    float invRampFrames;
    ramp_status_t status;

    float DBG_ramp_ms;
    float DBG_rampFrames;

}audiogain_t;
# 64 "../src/audio/gain_ctrl.h"
...
extern void app_mute_set( 
# 67 "../src/audio/gain_ctrl.h" 3 4
                           _Bool 
# 67 "../src/audio/gain_ctrl.h"
                                mute );
...
# 36 "../src/main.c" 2
# 1 "../src/audio/tone_ctrl.h" 1
# 20 "../src/audio/tone_ctrl.h"
typedef struct
{
    int in_buf_ch;
...
extern void tone_process( tone_t* ptone,
                           const float* in,
                                 ...
                                 int frameSize );
# 37 "../src/main.c" 2
# 1 "../src/audio/lpf_process.h" 1
# 18 "../src/audio/lpf_process.h"
typedef struct
{
    int in_buf_ch;
...
extern void app_lpf_enable( 
# 62 "../src/audio/lpf_process.h" 3 4
                             _Bool 
# 62 "../src/audio/lpf_process.h"
                                  enable );
...
extern void app_hpf_enable( 
# 42 "../src/audio/hpf_process.h" 3 4
                             _Bool 
# 42 "../src/audio/hpf_process.h"
                                  enable );
...
extern void hpf_process24( hpf_t* phpf,
                          const float* in,
                                ...
                                int samples );
# 39 "../src/main.c" 2
# 1 "../src/audio/transient.h" 1
# 25 "../src/audio/transient.h"
typedef struct {
    int ena_transient;
    int in_buf_ch;
...
# 40 "../src/main.c" 2
# 1 "../src/audio/reverb.h" 1
# 28 "../src/audio/reverb.h"
typedef struct
{
    int in_buf_ch;
...
# 41 "../src/main.c" 2
# 1 "../src/audio/reverb_smooth.h" 1
# 27 "../src/audio/reverb_smooth.h"
typedef struct
{
    int chPerFs;
    int chProcs;
...
# 42 "../src/main.c" 2
# 1 "../src/audio/widen_ctrl.h" 1
# 25 "../src/audio/widen_ctrl.h"
typedef struct
{
...
# 33 "../src/audio/widen_ctrl.h" 3 4
   _Bool 
# 33 "../src/audio/widen_ctrl.h"
          enabled;
...
# 47 "../src/audio/widen_ctrl.h" 3 4
   _Bool 
# 47 "../src/audio/widen_ctrl.h"
          use_delay;
    float delay_ms;
    float *delay_buf;
    int delay_len;
...
# 54 "../src/audio/widen_ctrl.h" 3 4
   _Bool 
# 54 "../src/audio/widen_ctrl.h"
          use_allpass;
    float ap_a;
    float ap_x1;
    float ap_y1;
} widen_t;
# 75 "../src/audio/widen_ctrl.h"
...
# 93 "../src/audio/widen_ctrl.h" 3 4
                                _Bool 
# 93 "../src/audio/widen_ctrl.h"
                                      enabled,
                                 float out_gain_db,
                                 float side_gain,
                                 float side_hpf_hz,
                                 
# 97 "../src/audio/widen_ctrl.h" 3 4
                                _Bool 
# 97 "../src/audio/widen_ctrl.h"
                                      use_delay,
                                 float delay_ms,
                                 
# 99 "../src/audio/widen_ctrl.h" 3 4
                                _Bool 
# 99 "../src/audio/widen_ctrl.h"
                                      use_allpass,
                                 float ap_a );
...
extern void widen_process( widen_t *w,
                              ...
                              int samples );
# 43 "../src/main.c" 2
# 1 "../src/audio/bass_enhancer.h" 1
# 22 "../src/audio/bass_enhancer.h"
typedef struct {

    
# 24 "../src/audio/bass_enhancer.h" 3 4
   _Bool 
# 24 "../src/audio/bass_enhancer.h"
         enabled;
...
# 39 "../src/audio/bass_enhancer.h" 3 4
   _Bool 
# 39 "../src/audio/bass_enhancer.h"
         bloom_enabled;
    float bloom_time_ms;
    float bloom_delay_ms;
    float bloom_mix;
    float bloom_duck;
...
# 59 "../src/audio/bass_enhancer.h" 3 4
       _Bool 
# 59 "../src/audio/bass_enhancer.h"
             enabled;
        float Bmax_dB;
        float alpha;
        float beta;
...
typedef struct {
    ...
    biquad_mono_t lpf_low1[((2))];
    biquad_mono_t lpf_low2[((2))];

    biquad_mono_t hpf_dc[((2))];
    ...
    float dbg_g_exc;
    float dbg_low_fc;
# 127 "../src/audio/bass_enhancer.h"
    float bloom_buf[2048];
    int bloom_w;
    int bloom_D;
    float bloom_g;
...
# 158 "../src/audio/bass_enhancer.h"
extern bassh_t g_bassh;
# 167 "../src/audio/bass_enhancer.h"
void app_bassh_init(void);
void app_bassh_enable(
# 168 "../src/audio/bass_enhancer.h" 3 4
                     _Bool 
# 168 "../src/audio/bass_enhancer.h"
                          en);

# 169 "../src/audio/bass_enhancer.h" 3 4
_Bool 
# 169 "../src/audio/bass_enhancer.h"
    app_bassh_is_enabled(void);
...
# 44 "../src/main.c" 2
# 1 "../src/audio/simple_loudmeter.h" 1
# 44 "../src/audio/simple_loudmeter.h"
typedef struct {
    ...
    float gainSmoothRise_ms;
    float gainSmoothFall_ms;
    float currBoost_dB;


    float bypassThresh_dB;
...
# 83 "../src/audio/simple_loudmeter.h"
...
# 47 "../src/main.c" 2
# 1 "../src/audio/engine_synth.h" 1
# 49 "../src/audio/engine_synth.h"
typedef enum
{
    ENG_I4 = 0,
    ENG_I5,
...
# 200 "../src/audio/engine_synth.h"
typedef struct {
    float peak_rpm_default;
    float attack_ms;
    float hold_ms;
    float decay_ms;
    float cooldown_ms;
    float min_accept_rpm;
...
# 48 "../src/main.c" 2
# 1 "../src/audio/click_crack_synth.h" 1
# 38 "../src/audio/click_crack_synth.h"
typedef enum {
...
# 65 "../src/audio/click_crack_synth.h" 3 4
   _Bool 
# 65 "../src/audio/click_crack_synth.h"
         alt_pan_each_fire;
...
void ccs_set_enabled(ccs_t *st, 
# 90 "../src/audio/click_crack_synth.h" 3 4
                               _Bool 
# 90 "../src/audio/click_crack_synth.h"
                                    enabled);
...
void ccs_set_po(ccs_t* pst, 
# 99 "../src/audio/click_crack_synth.h" 3 4
                           _Bool 
# 99 "../src/audio/click_crack_synth.h"
                                enabled, float delay_sec, float gain, float fc, float decay_tau_sec);
...
void app_ccsynth_set_enable(
# 112 "../src/audio/click_crack_synth.h" 3 4
                           _Bool 
# 112 "../src/audio/click_crack_synth.h"
                                enable);
void app_ccsynth_process(float* in, float* out);
# 49 "../src/main.c" 2
# 1 "../src/eq_lib/eq_perseus_wrapper.h" 1
# 14 "../src/eq_lib/eq_perseus_wrapper.h"
# 1 "../src/eq_lib/../app_specific_config_defs.h" 1
# 15 "../src/eq_lib/eq_perseus_wrapper.h" 2
# 1 "../src/eq_lib/eq_api_33AK.h" 1
# 16 "../src/eq_lib/eq_perseus_wrapper.h" 2
# 43 "../src/eq_lib/eq_perseus_wrapper.h"
typedef enum {
    EQ_PRESET_FLAT = 0,
...
void eq_perseus_enable(
# 105 "../src/eq_lib/eq_perseus_wrapper.h" 3 4
                      _Bool 
# 105 "../src/eq_lib/eq_perseus_wrapper.h"
                           enable);
...
# 112 "../src/eq_lib/eq_perseus_wrapper.h" 3 4
_Bool 
# 112 "../src/eq_lib/eq_perseus_wrapper.h"
    eq_perseus_is_enabled(void);
...
static void local_dbg_RGB_pot( void )
{
    ...
    pwm3_set_duty( rate );
    pwm1_set_duty( 100 - rate );
    pwm2_set_duty( 50 - abs(rate - 50) );
}


static void local_dbg_print( void )
{
    static uint32_t last_prt_1 = 0xffffffffUL;
    static uint32_t last_prt_2 = 0xffffffffUL;
    static uint32_t last_prt_3 = 0xffffffffUL;
           uint32_t cur = GetTicks();



    if ((uint32_t)(cur - last_prt_1) >= 5000)
    {
    ...
    if ((uint32_t)(cur - last_prt_3) >= 200)
    {
