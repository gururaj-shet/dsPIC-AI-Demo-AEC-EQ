...
# 28 "../src/audio/click_crack_synth.c" 2
...
# 30 "../src/audio/click_crack_synth.c" 2
...
# 35 "../src/audio/click_crack_synth.c" 2
...
float y1f(float);
float ynf(int, float);
# 36 "../src/audio/click_crack_synth.c" 2
...
# 39 "../src/audio/click_crack_synth.c" 2
# 54 "../src/audio/click_crack_synth.c"
typedef struct {

    
# 56 "../src/audio/click_crack_synth.c" 3 4
   _Bool 
# 56 "../src/audio/click_crack_synth.c"
            active;
    uint32_t age;
    uint32_t dur;
...
# 86 "../src/audio/click_crack_synth.c" 3 4
   _Bool 
# 86 "../src/audio/click_crack_synth.c"
         alt_pan_each_fire;
    float detune_fc_hz;
...
# 95 "../src/audio/click_crack_synth.c" 3 4
   _Bool 
# 95 "../src/audio/click_crack_synth.c"
         enabled;
    int32_t next_fire_countdown;
    
# 97 "../src/audio/click_crack_synth.c" 3 4
   _Bool 
# 97 "../src/audio/click_crack_synth.c"
         flip_pan;
...
# 106 "../src/audio/click_crack_synth.c" 3 4
   _Bool 
# 106 "../src/audio/click_crack_synth.c"
            po_enabled;
    int32_t po_countdown;
    float po_gain;
    float po_fc;
    float po_dec_mul;
    float po_delay_sec;
...
static inline float fast_sin(float x) { return 
# 116 "../src/audio/click_crack_synth.c" 3 4
                                              __builtin_sinf
# 116 "../src/audio/click_crack_synth.c"
                                                  (x); }
...
static inline void pan_to_lr(float pan, float *gl, float *gr)
{
    ...
    float p = clamp01(0.5f * (pan + 1.0f));
    float L = 
# 124 "../src/audio/click_crack_synth.c" 3 4
             __builtin_cosf
# 124 "../src/audio/click_crack_synth.c"
                 (0.5f * (float)
# 124 "../src/audio/click_crack_synth.c" 3 4
...
# 124 "../src/audio/click_crack_synth.c"
                                     * p);
    float R = 
# 125 "../src/audio/click_crack_synth.c" 3 4
             __builtin_sinf
# 125 "../src/audio/click_crack_synth.c"
                 (0.5f * (float)
# 125 "../src/audio/click_crack_synth.c" 3 4
                                3.14159265358979323846 
# 125 "../src/audio/click_crack_synth.c"
...
static void voice_start_from_base(ccs_voice_t *v, struct ccs_ *st)
{
    memset(v, 0, sizeof(*v));
    v->active = 
# 145 "../src/audio/click_crack_synth.c" 3 4
               1
# 145 "../src/audio/click_crack_synth.c"
                   ;
    v->age = 0;
    ...
    v->dph1 = 2.0f * (float)
# 160 "../src/audio/click_crack_synth.c" 3 4
                           3.14159265358979323846 
# 160 "../src/audio/click_crack_synth.c"
                                * fc / st->fs;
    v->dph2 = 2.0f * (float)
# 161 "../src/audio/click_crack_synth.c" 3 4
                           3.14159265358979323846 
# 161 "../src/audio/click_crack_synth.c"
                                * fc2 / st->fs;
...
{
    for (int i = 0; i < 4; ++i) if (!st->v[i].active) return i;

    int oldest = 0; uint32_t maxAge = 0;
    for (int i = 0; i < 4; ++i) { if (st->v[i].age > maxAge) { maxAge = st->v[i].age; oldest = i; } }
    return oldest;
}
                               ...
                               float fc, float amp, float dec_mul)
{
    memset(v, 0, sizeof(*v));
    v->active = 
# 189 "../src/audio/click_crack_synth.c" 3 4
                 1
# 189 "../src/audio/click_crack_synth.c"
                     ;
    v->age = 0;
    ...
    v->dph1 = 2.0f * (float)
# 196 "../src/audio/click_crack_synth.c" 3 4
                           3.14159265358979323846 
# 196 "../src/audio/click_crack_synth.c"
                                * fc / st->fs;
    v->ph1 = 0.0f;
    v->g1 = amp;
    v->g2 = 0.0f;
...
# 216 "../src/audio/click_crack_synth.c"
void ccs_preset(ccs_cfg_t *cfg, ccs_preset_t preset)
{
    if (!cfg) return;
    ...
    cfg->interval_sec = (1.00f);
    cfg->pan = 0.0f;
    cfg->alt_pan_each_fire = 
# 225 "../src/audio/click_crack_synth.c" 3 4
                            0
# 225 "../src/audio/click_crack_synth.c"
                                 ;
    ...
    default:
        ...
        cfg->amp = (0.036f * (0.47f));
        cfg->amp2 = 0.0f;
        cfg->fc = 400.0f;
        cfg->attack_sec = 0.004f;
        cfg->decay_tau_sec = 0.035f;
        cfg->dur_sec = 0.080f;
        break;
    }
}
...
void ccs_init(ccs_t *pst, const ccs_cfg_t *cfg)
{
    ...
    st->enabled = 
# 303 "../src/audio/click_crack_synth.c" 3 4
                 0
# 303 "../src/audio/click_crack_synth.c"
                      ;
    st->flip_pan = 
# 304 "../src/audio/click_crack_synth.c" 3 4
                  0
# 304 "../src/audio/click_crack_synth.c"
                       ;
    ...
    for (int i = 0; i < 4; ++i) st->v[i].active = 
# 315 "../src/audio/click_crack_synth.c" 3 4
                                                              0
# 315 "../src/audio/click_crack_synth.c"
                                                                   ;
    st->next_fire_countdown = 0;

    st->po_enabled = 
# 318 "../src/audio/click_crack_synth.c" 3 4
                      0
# 318 "../src/audio/click_crack_synth.c"
                           ;
    st->po_countdown = -1;
    st->po_gain = 0.55f;
    st->po_fc = 380.0f;
    st->po_dec_mul = expf(-1.0f / (0.055f * st->fs));
    st->po_delay_sec = 0.032f;
}
...
void ccs_reset(ccs_t *pst)
{
    ...
    for (int i = 0; i < 4; ++i) st->v[i].active = 
# 329 "../src/audio/click_crack_synth.c" 3 4
                                                              0
# 329 "../src/audio/click_crack_synth.c"
                                                                   ;
    st->next_fire_countdown = 0;
    st->flip_pan = 
# 331 "../src/audio/click_crack_synth.c" 3 4
                  0
# 331 "../src/audio/click_crack_synth.c"
                       ;
}

void ccs_set_enabled(ccs_t *pst, 
# 334 "../src/audio/click_crack_synth.c" 3 4
                                _Bool 
# 334 "../src/audio/click_crack_synth.c"
                                     enabled)
{
...
void ccs_set_po(ccs_t* pst, 
# 381 "../src/audio/click_crack_synth.c" 3 4
                           _Bool 
# 381 "../src/audio/click_crack_synth.c"
                                enabled,
...
static void maybe_schedule_auto_fire(struct ccs_ *st)
{
    ...
    if (st->next_fire_countdown < 1) st->next_fire_countdown = 1;
}
...
static inline float render_one_voice_mono(ccs_voice_t *v)
{
    ...
    float a = 1.0f;
    if (v->age < v->att_smpl && v->att_smpl > 0) a = (float)v->age / (float)v->att_smpl;
    ...
    v->ph1 += v->dph1; if (v->ph1 > 2.0f * (float)
# 443 "../src/audio/click_crack_synth.c" 3 4
                                                 3.14159265358979323846
# 443 "../src/audio/click_crack_synth.c"
                                                     ) v->ph1 -= 2.0f * (float)
# 443 "../src/audio/click_crack_synth.c" 3 4
                                                                               3.14159265358979323846
# 443 "../src/audio/click_crack_synth.c"
                                                                                   ;
    v->ph2 += v->dph2; if (v->ph2 > 2.0f * (float)
# 444 "../src/audio/click_crack_synth.c" 3 4
                                                 3.14159265358979323846
# 444 "../src/audio/click_crack_synth.c"
                                                     ) v->ph2 -= 2.0f * (float)
# 444 "../src/audio/click_crack_synth.c" 3 4
                                                                               3.14159265358979323846
# 444 "../src/audio/click_crack_synth.c"
    ...
    v->age++;
    if (v->age >= v->dur) v->active = 
# 447 "../src/audio/click_crack_synth.c" 3 4
                                     0
# 447 "../src/audio/click_crack_synth.c"
                                          ;
...
size_t ccs_process_stereo_add(ccs_t *pst, const float *in, float *out, size_t nframes)
{
    ...
    for (size_t n = 0; n < nframes; ++n) {
        ...
        float L = 0.0f, R = 0.0f;
        for (int i = 0; i < 4; ++i) if (st->v[i].active) {
...
void app_ccsynth_init(void)
{
    ...
    ccs_set_po(&g_ccs, 
# 499 "../src/audio/click_crack_synth.c" 3 4
                      1
# 499 "../src/audio/click_crack_synth.c"
                          ,
...
void app_ccsynth_set_enable(
# 510 "../src/audio/click_crack_synth.c" 3 4
                           _Bool 
# 510 "../src/audio/click_crack_synth.c"
                                enable)
{
...
void app_ccsynth_process(float* in, float* out)
{
    ...
    ccs_process_stereo_add(&g_ccs, in, out, (32));
}
