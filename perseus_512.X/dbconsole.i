...
# 11 "../src/debug/dbconsole.c" 2
# 21 "../src/debug/dbconsole.c"
static struct {
    uint8_t buf[(384u)];
    uint16_t idx;
} s_rx;
# 35 "../src/debug/dbconsole.c"
static inline void line_reset(void);
static inline 
# 36 "../src/debug/dbconsole.c" 3 4
             _Bool 
# 36 "../src/debug/dbconsole.c"
                     is_hex(uint8_t c);
static inline uint8_t hex_val(uint8_t c);
static 
# 38 "../src/debug/dbconsole.c" 3 4
      _Bool 
# 38 "../src/debug/dbconsole.c"
                     hex_pair_to_byte(uint8_t hi, uint8_t lo, uint8_t* out);
...
# 66 "../src/debug/dbconsole.c" 3 4
_Bool 
# 66 "../src/debug/dbconsole.c"
    dbc_feed_char(uint8_t ch)
{
    if (s_rx.idx >= (384u)) { line_reset(); }
    ...
    if (ch == ('\r')) { return 
# 75 "../src/debug/dbconsole.c" 3 4
                                                             0
# 75 "../src/debug/dbconsole.c"
                                                                  ; }
    if (ch != ('\n')) { return 
# 76 "../src/debug/dbconsole.c" 3 4
                                                             0
# 76 "../src/debug/dbconsole.c"
                                                                  ; }
    if (s_rx.idx < (4u)) { line_reset(); return 
# 77 "../src/debug/dbconsole.c" 3 4
                                                             0
# 77 "../src/debug/dbconsole.c"
                                                                  ; }
    ...
    return 
# 131 "../src/debug/dbconsole.c" 3 4
          1
# 131 "../src/debug/dbconsole.c"
              ;
}
...
static inline 
# 144 "../src/debug/dbconsole.c" 3 4
             _Bool 
# 144 "../src/debug/dbconsole.c"
                  is_hex(uint8_t c)
{
    if (c >= '0' && c <= '9') return 
# 146 "../src/debug/dbconsole.c" 3 4
                                    1
# 146 "../src/debug/dbconsole.c"
                                        ;
    if (c >= 'a' && c <= 'f') return 
# 147 "../src/debug/dbconsole.c" 3 4
                                    1
# 147 "../src/debug/dbconsole.c"
                                        ;
    if (c >= 'A' && c <= 'F') return 
# 148 "../src/debug/dbconsole.c" 3 4
                                    1
# 148 "../src/debug/dbconsole.c"
                                        ;
    return 
# 149 "../src/debug/dbconsole.c" 3 4
          0
# 149 "../src/debug/dbconsole.c"
               ;
}
...
static 
# 159 "../src/debug/dbconsole.c" 3 4
      _Bool 
# 159 "../src/debug/dbconsole.c"
           hex_pair_to_byte(uint8_t hi, uint8_t lo, uint8_t* out)
{
    if (!is_hex(hi)) return 
# 161 "../src/debug/dbconsole.c" 3 4
                           0
# 161 "../src/debug/dbconsole.c"
                                ;
    if (!is_hex(lo)) return 
# 162 "../src/debug/dbconsole.c" 3 4
                           0
# 162 "../src/debug/dbconsole.c"
                                ;
    if (!out) return 
# 163 "../src/debug/dbconsole.c" 3 4
                    0
# 163 "../src/debug/dbconsole.c"
                         ;
    *out = (uint8_t)((hex_val(hi) << 4) | hex_val(lo));
    return 
# 165 "../src/debug/dbconsole.c" 3 4
          1
# 165 "../src/debug/dbconsole.c"
              ;
}
