...
# 22 "../src/debug/app_debug.c" 2
# 1 "../src/debug/eq_benchmark.h" 1
# 19 "../src/debug/eq_benchmark.h"
void eq_benchmark_init(void);
# 31 "../src/debug/eq_benchmark.h"
...
static void dbcapp_e_onmsg(dbc_msg_t* pmsg)
{
    ...
    case 'a':
        if (pmsg->kind == '?')
        {
            ...
            pmsg->data[8] = (uint8_t)(int8_t)gain_dB;
            pmsg->data[8 + 1] = eq_perseus_is_enabled() ? 1 : 0;
            pmsg->data_len = 8 + 2;
            pmsg->status = (0x80u);
        }
        else
