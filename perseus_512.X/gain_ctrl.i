...
# 20 "../src/audio/gain_ctrl.c" 2
# 34 "../src/audio/gain_ctrl.c"
           audiogain_t My_Gain;
# 46 "../src/audio/gain_ctrl.c"
...
# 76 "../src/audio/gain_ctrl.c"
void app_gain_process( float* p_in, float* p_out )
{
    gain_process( &My_Gain, p_in, p_out, (32) );
}


void app_mute_set( 
# 82 "../src/audio/gain_ctrl.c" 3 4
                  _Bool 
# 82 "../src/audio/gain_ctrl.c"
                       mute )
{
