...
# 20 "../src/debug/eq_benchmark.c" 2
# 1 "../src/debug/../audio/tone_ctrl.h" 1
# 20 "../src/debug/../audio/tone_ctrl.h"
typedef struct
{
    int in_buf_ch;
...
# 56 "../src/debug/../audio/tone_ctrl.h"
...
extern void tone_process( tone_t* ptone,
                           const float* in,
                                 float* out,
                                 int frameSize );
# 21 "../src/debug/eq_benchmark.c" 2
# 1 "../src/debug/../eq_lib/eq_perseus_wrapper.h" 1
# 14 "../src/debug/../eq_lib/eq_perseus_wrapper.h"
# 1 "../src/debug/../eq_lib/../app_specific_config_defs.h" 1
# 15 "../src/debug/../eq_lib/eq_perseus_wrapper.h" 2
# 1 "../src/debug/../eq_lib/eq_api_33AK.h" 1
# 71 "../src/debug/../eq_lib/eq_api_33AK.h"
typedef enum {
    EQ_BAND_32HZ = 0,
    EQ_BAND_62HZ = 1,
    EQ_BAND_125HZ = 2,
...
# 91 "../src/debug/../eq_lib/eq_api_33AK.h"
typedef struct {
    float b0;
    float b1;
    float b2;
...
# 266 "../src/debug/../eq_lib/eq_api_33AK.h"
void EQ_Enable(eq_instance_t *eq, 
# 266 "../src/debug/../eq_lib/eq_api_33AK.h" 3 4
                                 _Bool 
# 266 "../src/debug/../eq_lib/eq_api_33AK.h"
                                      enable);
...
# 360 "../src/debug/../eq_lib/eq_api_33AK.h"
...
# 16 "../src/debug/../eq_lib/eq_perseus_wrapper.h" 2
# 43 "../src/debug/../eq_lib/eq_perseus_wrapper.h"
typedef enum {
    EQ_PRESET_FLAT = 0,
...
# 66 "../src/debug/../eq_lib/eq_perseus_wrapper.h"
int eq_perseus_init(void);
# 77 "../src/debug/../eq_lib/eq_perseus_wrapper.h"
void eq_perseus_process(float* audio_buf, int num_samples, int num_channels);
# 87 "../src/debug/../eq_lib/eq_perseus_wrapper.h"
void eq_perseus_process_mono(float* audio_buf, int num_samples);
# 98 "../src/debug/../eq_lib/eq_perseus_wrapper.h"
...
# 105 "../src/debug/../eq_lib/eq_perseus_wrapper.h" 3 4
                      _Bool 
# 105 "../src/debug/../eq_lib/eq_perseus_wrapper.h"
                           enable);
...
# 112 "../src/debug/../eq_lib/eq_perseus_wrapper.h" 3 4
_Bool 
# 112 "../src/debug/../eq_lib/eq_perseus_wrapper.h"
...
# 22 "../src/debug/eq_benchmark.c" 2
# 43 "../src/debug/eq_benchmark.c"
static inline void bench_timer_init(void)
{


    
# 47 "../src/debug/eq_benchmark.c" 3 4
   T1CON 
# 47 "../src/debug/eq_benchmark.c"
         = 0;
    
# 48 "../src/debug/eq_benchmark.c" 3 4
   TMR1 
# 48 "../src/debug/eq_benchmark.c"
        = 0;
    
# 49 "../src/debug/eq_benchmark.c" 3 4
   PR1 
# 49 "../src/debug/eq_benchmark.c"
       = 0xFFFF;
    T1CONbits.TCKPS = 0;
    T1CONbits.ON = 1;
}
...
{
    return 
# 56 "../src/debug/eq_benchmark.c" 3 4
          TMR1
# 56 "../src/debug/eq_benchmark.c"
              ;
}
...
# 61 "../src/debug/eq_benchmark.c" 3 4
   TMR1 
# 61 "../src/debug/eq_benchmark.c"
        = 0;
}
# 80 "../src/debug/eq_benchmark.c"
static float bench_input[(32) * (2)];
static float bench_output_tone[(32) * (2)];
static float bench_output_eq[(32) * (2)];
...
static void bench_generate_test_signal(void)
{
    ...
    for (i = 0; i < (32) * (2); i++)
    {
        ...
        bench_input[i] = 0.5f * 
# 94 "../src/debug/eq_benchmark.c" 3 4
                               __builtin_sinf
# 94 "../src/debug/eq_benchmark.c"
                                   (phase);
        phase += freq_inc;
        if (phase > 6.28318f) phase -= 6.28318f;
    }
}
# 108 "../src/debug/eq_benchmark.c"
...
static uint32_t bench_eq_lib(void)
{
    ...
    eq_perseus_process_mono(bench_output_eq, (32) * (2));
...
void eq_benchmark_run(void)
{
    ...
    float fcy = 100000000.0f;
    float frames_per_sec = (float)(48000) / (float)(32);
...
void eq_benchmark_compare_output(void)
{
    ...
    app_tone_set_coeffs_tre(3.0f);
    app_tone_set_coeffs_mid(0.0f);
    app_tone_set_coeffs_bas(6.0f);


    eq_perseus_set_band(0, 6.0f);
    eq_perseus_set_band(1, 6.0f);
    eq_perseus_set_band(2, 3.0f);
    eq_perseus_set_band(3, 0.0f);
    eq_perseus_set_band(4, 0.0f);
    eq_perseus_set_band(5, 0.0f);
    eq_perseus_set_band(6, 3.0f);
    eq_perseus_set_band(7, 3.0f);
