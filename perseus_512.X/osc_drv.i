...
void Set_OscSrc_to_CLKGEN8(CLK_GEN_SOURCE_T NewOsc)
{
    ...
    CLK8CONbits.NOSC = NewOsc;
    CLK8CONbits.ON = 1;
    CLK8CONbits.OE = 1;

    CLK8DIVbits.INTDIV = 0;
...
void Set_OscSrc_to_CLKGEN9(CLK_GEN_SOURCE_T NewOsc)
{
    ...
    CLK9CONbits.NOSC = NewOsc;
    CLK9CONbits.ON = 1;
    CLK9CONbits.OE = 1;

    CLK9DIVbits.INTDIV = 0;
                         ...
                         uint32_t req_Fosc_Hz )
{
    ...
    PLL1DIVbits.PLLFBDIV = u32_PLLFBD;
    PLL1DIVbits.PLLPRE = u16_PLLPRE;
    PLL1DIVbits.POSTDIV1 = ePLLPOST1;
    PLL1DIVbits.POSTDIV2 = ePLLPOST2;
                         ...
                         uint32_t req_Fosc_Hz )
{
    ...
    PLL2DIVbits.PLLPRE = u16_PLLPRE;
    PLL2DIVbits.POSTDIV1 = ePLLPOST1;
    PLL2DIVbits.POSTDIV2 = ePLLPOST2;
                                ...
                                uint16_t* p_outPLLPRE )
{
    ...
    for (u16_PLLPRE = 1; u16_PLLPRE < 9 ; u16_PLLPRE++)
    {
