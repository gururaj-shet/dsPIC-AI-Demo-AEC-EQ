...
# 23 "../src/audio/aec_33ak.c" 2
# 1 "../src/audio/aec_nlms_float.h" 1
# 32 "../src/audio/aec_nlms_float.h"
typedef struct {
    float mu;
    float delta;
    float alpha;
...
# 104 "../src/audio/aec_nlms_float.h"
float nlms_update_energy(float current_energy,
                         float new_sample,
                         float old_sample,
                         float alpha);
# 121 "../src/audio/aec_nlms_float.h"
...
# 128 "../src/audio/aec_nlms_float.h" 3 4
                         _Bool 
# 128 "../src/audio/aec_nlms_float.h"
                              adapt_flag);
# 24 "../src/audio/aec_33ak.c" 2
# 1 "../src/audio/aec_vad_float.h" 1
# 40 "../src/audio/aec_vad_float.h"
typedef enum {
    VAD_SILENCE = 0,
    VAD_SPEECH,
    VAD_UNKNOWN
...
# 61 "../src/audio/aec_vad_float.h" 3 4
   _Bool 
# 61 "../src/audio/aec_vad_float.h"
         is_speech;
    
# 62 "../src/audio/aec_vad_float.h" 3 4
   _Bool 
# 62 "../src/audio/aec_vad_float.h"
         first_frame;
    
# 63 "../src/audio/aec_vad_float.h" 3 4
   _Bool 
# 63 "../src/audio/aec_vad_float.h"
         update_noise;
    ...
    float window_overlap[128 / 4];

} vad_state_t;
# 81 "../src/audio/aec_vad_float.h"
...
# 112 "../src/audio/aec_vad_float.h" 3 4
_Bool 
# 112 "../src/audio/aec_vad_float.h"
    vad_inhibit_adaptation(const vad_state_t* state);
...
# 25 "../src/audio/aec_33ak.c" 2
# 1 "../src/audio/aec_src.h" 1
# 38 "../src/audio/aec_src.h"
typedef struct {
    float history[48];
    int history_idx;
    int phase_count;
...
# 103 "../src/audio/aec_33ak.c" 3 4
   _Bool 
# 103 "../src/audio/aec_33ak.c"
        adapt;
    vad_decision_t vad_result;


    vad_result = vad_process(&state->vad, state->mic_8k, 80);
    ...
    state->echo_power = fmaf(ERLE_ALPHA,
                             state->echo_power - echo_power_acc / 80,
                             echo_power_acc / 80);

    state->residual_power = fmaf(ERLE_ALPHA,
                                 state->residual_power - residual_power_acc / 80,
                                 residual_power_acc / 80);
...
void aec_init(aec_state_t* state, int filter_order, 
# 171 "../src/audio/aec_33ak.c" 3 4
                                                   _Bool 
# 171 "../src/audio/aec_33ak.c"
                                                        enable_vad)
{
...
void aec_reset(aec_state_t* state)
{
    ...
    aec_init(state, filter_order, 
# 215 "../src/audio/aec_33ak.c" 3 4
                                 1
# 215 "../src/audio/aec_33ak.c"
                                     );
    state->mode = mode;
}
...
# 246 "../src/audio/aec_33ak.c"
    ...
    state->frames_processed++;
    state->adapt_enabled = 
# 285 "../src/audio/aec_33ak.c" 3 4
                          1
# 285 "../src/audio/aec_33ak.c"
                              ;
}


void aec_enable(aec_state_t* state, 
# 289 "../src/audio/aec_33ak.c" 3 4
                                   _Bool 
# 289 "../src/audio/aec_33ak.c"
                                        enable)
{
...
# 311 "../src/audio/aec_33ak.c" 3 4
_Bool 
# 311 "../src/audio/aec_33ak.c"
    aec_is_near_end_speech(const aec_state_t* state)
{
