# 1 "../src/eq_lib/eq_perseus_wrapper.c"
...
# 9 "../src/eq_lib/../app_specific_config_defs.h" 2
...
# 10 "../src/eq_lib/../app_specific_config_defs.h" 2
...
int clearenv(void);
# 11 "../src/eq_lib/../app_specific_config_defs.h" 2

# 1 "c:\\program files\\microchip\\xc-dsc\\v3.31\\include\\stdbool.h" 1 3 4
# 13 "../src/eq_lib/../app_specific_config_defs.h" 2
# 144 "../src/eq_lib/../app_specific_config_defs.h"
...
# 9 "../src/eq_lib/eq_perseus_wrapper.c" 2
...
# 10 "../src/eq_lib/eq_perseus_wrapper.c" 2
...
# 16 "../src/eq_lib/eq_perseus_wrapper.c"
...
static 
# 22 "../src/eq_lib/eq_perseus_wrapper.c" 3 4
      _Bool 
# 22 "../src/eq_lib/eq_perseus_wrapper.c"
           g_eq_initialized = 
# 22 "../src/eq_lib/eq_perseus_wrapper.c" 3 4
                              0
# 22 "../src/eq_lib/eq_perseus_wrapper.c"
...
static const float g_presets[EQ_PRESET_COUNT][8] = {
...
int eq_perseus_init(void)
{
    ...
    result = EQ_Init(&g_eq_left, ((float)(48000)));
    if (result != 0)
    {
        return -1;
    }
    ...
    result = EQ_Init(&g_eq_right, ((float)(48000)));
    if (result != 0)
    {
        return -1;
    }
    ...
    g_eq_initialized = 
# 96 "../src/eq_lib/eq_perseus_wrapper.c" 3 4
                      1
# 96 "../src/eq_lib/eq_perseus_wrapper.c"
                          ;
...
void eq_perseus_process(float* audio_buf, int num_samples, int num_channels)
{
    if (!g_eq_initialized || audio_buf == 
# 103 "../src/eq_lib/eq_perseus_wrapper.c" 3 4
                                         ((void*)0) 
# 103 "../src/eq_lib/eq_perseus_wrapper.c"
                                              || num_samples <= 0)
    {
        return;
    }
...
{
    if (!g_eq_initialized || audio_buf == 
# 125 "../src/eq_lib/eq_perseus_wrapper.c" 3 4
                                         ((void*)0)
# 125 "../src/eq_lib/eq_perseus_wrapper.c"
                                             )
    {
        return;
    }
...
void eq_perseus_process_stereo(float* audio_buf, int num_samples)
{
    ...
    if (!g_eq_initialized || audio_buf == 
# 140 "../src/eq_lib/eq_perseus_wrapper.c" 3 4
                                         ((void*)0) 
# 140 "../src/eq_lib/eq_perseus_wrapper.c"
                                              || num_samples <= 0)
    {
        return;
    }
...
void eq_perseus_enable(
# 174 "../src/eq_lib/eq_perseus_wrapper.c" 3 4
                      _Bool 
# 174 "../src/eq_lib/eq_perseus_wrapper.c"
                           enable)
{
    if (g_eq_initialized)
    {
...
# 183 "../src/eq_lib/eq_perseus_wrapper.c" 3 4
_Bool 
# 183 "../src/eq_lib/eq_perseus_wrapper.c"
    eq_perseus_is_enabled(void)
{
    if (!g_eq_initialized)
    {
        return 
# 187 "../src/eq_lib/eq_perseus_wrapper.c" 3 4
              0
# 187 "../src/eq_lib/eq_perseus_wrapper.c"
                   ;
    }
...
void eq_perseus_set_band(int band, float gain_dB)
{
    if (!g_eq_initialized || band < 0 || band >= 8)
    {
        return;
    }
...
eq_instance_t* eq_perseus_get_instance(void)
{
    return g_eq_initialized ? &g_eq_left : 
# 269 "../src/eq_lib/eq_perseus_wrapper.c" 3 4
                                          ((void*)0)
# 269 "../src/eq_lib/eq_perseus_wrapper.c"
                                              ;
}
