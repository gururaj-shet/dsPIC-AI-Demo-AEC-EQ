...
# 148 "../src/pwm.c"
volatile uint32_t PWM5_Duty[ 2 *(32) *(8) ] __attribute__((aligned(4)));
volatile uint32_t PWM6_Duty[ 2 *(32) *(8) ] __attribute__((aligned(4)));
volatile uint32_t PWM7_Duty[ 2 *(32) *(8) ] __attribute__((aligned(4)));
volatile uint32_t PWM8_Duty[ 2 *(32) *(8) ] __attribute__((aligned(4)));
# 171 "../src/pwm.c"
...
# 403 "../src/pwm.c"
    ...
    Osc_Configure_PLL2( CLK_SIB_SOURCE_REFI1, (12288000), ((12288000)*(60)) );
...
void dma4_pwm5_process( float* in, int in_buf_ch )
{
               ...
               uint32_t Half_PWM_Addr = (uint32_t)&PWM5_Duty[(32)*(8)];
...
# 454 "../src/pwm.c"
    ...
    else
    {
        ...
        dest_ptr = (int32_t*)&PWM5_Duty[(32)*(8)];
    }


    convert_float_to_pwm_20bit( in, (2), 0 , dest_ptr, (32), (8), ((((12288000)*(60))/((48000)*(8))) <<4) );
}
...
void dma5_pwm6_process( float* in, int in_buf_ch )
{
               ...
               uint32_t Half_PWM_Addr = (uint32_t)&PWM6_Duty[(32)*(8)];
    uint32_t dma_tx_addr;
    int32_t* dest_ptr;
...
# 481 "../src/pwm.c"
    ...
    else
    {
        ...
        dest_ptr = (int32_t*)&PWM6_Duty[(32)*(8)];
    }


    convert_float_to_pwm_20bit( in, (2), 1 , dest_ptr, (32), (8), ((((12288000)*(60))/((48000)*(8))) <<4) );
}
...
void dma6_pwm7_process( float* in, int in_buf_ch )
{
               ...
               uint32_t Half_PWM_Addr = (uint32_t)&PWM7_Duty[(32)*(8)];
    uint32_t dma_tx_addr;
    int32_t* dest_ptr;
...
# 508 "../src/pwm.c"
    ...
    else
    {
        ...
        dest_ptr = (int32_t*)&PWM7_Duty[(32)*(8)];
    }
...
void dma7_pwm8_process( float* in, int in_buf_ch )
{
               ...
               uint32_t Half_PWM_Addr = (uint32_t)&PWM8_Duty[(32)*(8)];
    uint32_t dma_tx_addr;
    int32_t* dest_ptr;
...
# 535 "../src/pwm.c"
    ...
    else
    {
        ...
        dest_ptr = (int32_t*)&PWM8_Duty[(32)*(8)];
    }
...
void pwm1_set_duty(uint8_t duty)
{
    ...
    PG1DCbits.DC = (((((12288000)*(60))/((48000)*(8))) <<4)*duty/100) * (0.3);
}
...
void pwm2_set_duty(uint8_t duty)
{
    ...
    PG2DCbits.DC = (((((12288000)*(60))/((48000)*(8))) <<4)*duty/100) * (0.3);
}
...
void pwm3_set_duty(uint8_t duty)
{
    ...
    PG3DCbits.DC = (((((12288000)*(60))/((48000)*(8))) <<4)*duty/100) * (0.25);
}
# 616 "../src/pwm.c"
static void pwm1_init(void)
{
...
# 622 "../src/pwm.c"
    ...
    PG1PERbits.PER = ((((12288000)*(60))/((48000)*(8))) <<4)-1;
    PG1DCbits.DC = 1;
    ...
    PG1DTbits.DTL = (8);
# 686 "../src/pwm.c"
    PG1EVT1bits.UPDTRG = 0b01;
# 696 "../src/pwm.c"
    PG1EVT1bits.PGTRGSEL = 0b00;
...
# 731 "../src/pwm.c"
    ...
    PG2PERbits.PER = ((((12288000)*(60))/((48000)*(8))) <<4)-1;
    PG2DCbits.DC = 1;
    ...
    PG2DTbits.DTL = (8);
# 793 "../src/pwm.c"
    PG2EVT1bits.UPDTRG = 0b01;
# 803 "../src/pwm.c"
    PG2EVT1bits.PGTRGSEL = 0b00;
...
# 837 "../src/pwm.c"
    ...
    PG3PERbits.PER = ((((12288000)*(60))/((48000)*(8))) <<4)-1;
    PG3DCbits.DC = 1;
    ...
    PG3DTbits.DTL = (8);
# 898 "../src/pwm.c"
    PG3EVT1bits.UPDTRG = 0b01;
# 908 "../src/pwm.c"
    PG3EVT1bits.PGTRGSEL = 0b00;
...
# 958 "../src/pwm.c"
    ...
    PG5PERbits.PER = ((((12288000)*(60))/((48000)*(8))) <<4)-1;
    PG5DCbits.DC = (((((12288000)*(60))/((48000)*(8))) <<4)/2);
    ...
    PG5DTbits.DTL = (64);
# 998 "../src/pwm.c"
    PG5EVT1bits.UPDTRG = 0b01;
# 1008 "../src/pwm.c"
    PG5EVT1bits.PGTRGSEL = 0b00;
...
# 1058 "../src/pwm.c"
    ...
    PG6PERbits.PER = ((((12288000)*(60))/((48000)*(8))) <<4)-1;
    PG6DCbits.DC = (((((12288000)*(60))/((48000)*(8))) <<4)/2);
    ...
    PG6DTbits.DTL = (64);
# 1098 "../src/pwm.c"
    PG6EVT1bits.UPDTRG = 0b01;
# 1108 "../src/pwm.c"
    PG6EVT1bits.PGTRGSEL = 0b00;
...
# 1167 "../src/pwm.c"
    ...
    PG7PERbits.PER = ((((12288000)*(60))/((48000)*(8))) <<4)-1;
    PG7DCbits.DC = (((((12288000)*(60))/((48000)*(8))) <<4)/2);
    ...
    PG7DTbits.DTL = (64);
# 1207 "../src/pwm.c"
    PG7EVT1bits.UPDTRG = 0b01;
# 1217 "../src/pwm.c"
    PG7EVT1bits.PGTRGSEL = 0b00;
...
# 1268 "../src/pwm.c"
    ...
    PG8PERbits.PER = ((((12288000)*(60))/((48000)*(8))) <<4)-1;
    PG8DCbits.DC = (((((12288000)*(60))/((48000)*(8))) <<4)/2);
    ...
    PG8DTbits.DTL = (64);
# 1308 "../src/pwm.c"
    PG8EVT1bits.UPDTRG = 0b01;
# 1318 "../src/pwm.c"
    PG8EVT1bits.PGTRGSEL = 0b00;
...
# 1361 "../src/pwm.c" 3 4
   DMA4CNT 
# 1361 "../src/pwm.c"
           = (sizeof(PWM5_Duty) / sizeof((PWM5_Duty)[0]));
    ...
    DMA4CHbits.RELOADC = 1;
    DMA4CHbits.RELOADS = 1;
    DMA4CHbits.RELOADD = 0;
...
# 1420 "../src/pwm.c" 3 4
   DMA5CNT 
# 1420 "../src/pwm.c"
           = (sizeof(PWM6_Duty) / sizeof((PWM6_Duty)[0]));
    ...
    DMA5CHbits.RELOADC = 1;
    DMA5CHbits.RELOADS = 1;
    DMA5CHbits.RELOADD = 0;
...
# 1479 "../src/pwm.c" 3 4
   DMA6CNT 
# 1479 "../src/pwm.c"
           = (sizeof(PWM7_Duty) / sizeof((PWM7_Duty)[0]));
    ...
    DMA6CHbits.RELOADC = 1;
    DMA6CHbits.RELOADS = 1;
    DMA6CHbits.RELOADD = 0;
...
# 1539 "../src/pwm.c" 3 4
   DMA7CNT 
# 1539 "../src/pwm.c"
           = (sizeof(PWM8_Duty) / sizeof((PWM8_Duty)[0]));
    ...
    DMA7CHbits.RELOADC = 1;
    DMA7CHbits.RELOADS = 1;
    DMA7CHbits.RELOADD = 0;
