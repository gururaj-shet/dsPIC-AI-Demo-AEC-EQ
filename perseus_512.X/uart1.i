...
# 9 "c:\\program files\\microchip\\xc-dsc\\v3.31\\include\\string.h" 2 3 4
...
# 44 "../src/uart/uart1.c" 2
# 1 "../src/app_specific_config_defs.h" 1
# 9 "../src/app_specific_config_defs.h"
...
void UART1_Initialize(void)
{
    ...
    RxRing_Idx_Read = 0;
    RxRing_Idx_Write = 0;
# 121 "../src/uart/uart1.c"
    (
# 121 "../src/uart/uart1.c" 3 4
   TRISDbits.TRISD1 
# 121 "../src/uart/uart1.c"
   = 1);
    (
# 122 "../src/uart/uart1.c" 3 4
   TRISHbits.TRISH1 
# 122 "../src/uart/uart1.c"
   = 0);
    (
# 123 "../src/uart/uart1.c" 3 4
   LATHbits.LATH1 
# 123 "../src/uart/uart1.c"
   = 1);


    RPINR13bits.U1RXR = 0x0032UL;
    RPOR28bits.RP114R = 0x0013UL;
# 149 "../src/uart/uart1.c"
    
# 149 "../src/uart/uart1.c" 3 4
   U1CON 
# 149 "../src/uart/uart1.c"
          = 0x0;
    ...
    U1CONbits.CLKSEL = 1;
# 178 "../src/uart/uart1.c"
    U1CONbits.CLKMOD = 1;
    U1CONbits.BRGS = 0;
# 190 "../src/uart/uart1.c"
    
# 190 "../src/uart/uart1.c" 3 4
   U1BRG 
# 190 "../src/uart/uart1.c"
         = 867;
# 199 "../src/uart/uart1.c"
    
# 199 "../src/uart/uart1.c" 3 4
   U1STAT 
# 199 "../src/uart/uart1.c"
          = 0x0;
...
# 208 "../src/uart/uart1.c" 3 4
   IFS3bits.U1RXIF 
# 208 "../src/uart/uart1.c"
                      = 0;
    
# 209 "../src/uart/uart1.c" 3 4
   IEC3bits.U1RXIE 
# 209 "../src/uart/uart1.c"
                      = 1;
# 218 "../src/uart/uart1.c"
    U1CONbits.TXEN = 1;
    U1CONbits.RXEN = 1;
}
...
# 225 "../src/uart/uart1.c" 3 4
   U1CON 
# 225 "../src/uart/uart1.c"
         = 0x0UL;
    
# 226 "../src/uart/uart1.c" 3 4
   U1STAT 
# 226 "../src/uart/uart1.c"
          = 0x2E0080UL;
    
# 227 "../src/uart/uart1.c" 3 4
   U1BRG 
# 227 "../src/uart/uart1.c"
         = 0x0UL;
}
# 242 "../src/uart/uart1.c"
uint8_t UART1_Read(void)
{
    uint8_t data = 0;
...
# 269 "../src/uart/uart1.c" 3 4
   U1TXB 
# 269 "../src/uart/uart1.c"
         = txData;
}
...
# 277 "../src/uart/uart1.c" 3 4
_Bool 
# 277 "../src/uart/uart1.c"
    UART1_IsRxReady(void)
{
...
# 285 "../src/uart/uart1.c" 3 4
_Bool 
# 285 "../src/uart/uart1.c"
    UART1_IsTxReady(void)
{
...
# 291 "../src/uart/uart1.c" 3 4
_Bool 
# 291 "../src/uart/uart1.c"
    UART1_IsTxDone(void)
{
    return (
# 293 "../src/uart/uart1.c" 3 4
           _Bool
# 293 "../src/uart/uart1.c"
               )(U1STATbits.TXMTIF && U1STATbits.TXBE);
}
# 325 "../src/uart/uart1.c"
size_t UART1_ErrorGet(void)
{
    uartError.status = 0;
...
# 407 "../src/uart/uart1.c"
void __attribute__((interrupt, no_auto_psv)) _U1RXInterrupt(void)
{
    
# 409 "../src/uart/uart1.c" 3 4
   IFS3bits.U1RXIF 
# 409 "../src/uart/uart1.c"
           = 0;


    while (U1STATbits.RXBE == 0)
    {
        RxRingBuf[ RxRing_Idx_Write++ ] = 
# 414 "../src/uart/uart1.c" 3 4
                                         U1RXB
# 414 "../src/uart/uart1.c"
                                              ;
        if( RxRing_Idx_Write >= (256) )
        {
            RxRing_Idx_Write = 0;
        }
    }
