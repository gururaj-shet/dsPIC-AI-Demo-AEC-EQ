...
extern void widen_process( widen_t *w,
                              ...
                              float *out,
                              int samples );
# 17 "../src/audio/widen_ctrl.c" 2
# 54 "../src/audio/widen_ctrl.c"
static widen_t g_widen;
static float g_delay_buf[(48000) * (10) /1000];


static widen_t g_widen2;
static float g_delay_buf2[(48000) * (10) /1000];
...
{
    widen_init(&g_widen, (2), 0, 1, g_delay_buf, (int)(sizeof(g_delay_buf) / sizeof((g_delay_buf)[0])));
    widen_set_params(&g_widen, 
# 67 "../src/audio/widen_ctrl.c" 3 4
                              0
# 67 "../src/audio/widen_ctrl.c"
                                   , 0.0f, 1.0f, 0.0f, 
# 67 "../src/audio/widen_ctrl.c" 3 4
                                                       0
# 67 "../src/audio/widen_ctrl.c"
...
# 67 "../src/audio/widen_ctrl.c"
    ...
    widen_init(&g_widen2, (2), 0, 1, g_delay_buf2, (int)(sizeof(g_delay_buf2) / sizeof((g_delay_buf2)[0])));
    widen_set_params(&g_widen2, 
# 70 "../src/audio/widen_ctrl.c" 3 4
                               0
# 70 "../src/audio/widen_ctrl.c"
                                    , 01.0f, 1.0f, 0.0f, 
# 70 "../src/audio/widen_ctrl.c" 3 4
                                                         0
# 70 "../src/audio/widen_ctrl.c"
...
# 79 "../src/audio/widen_ctrl.c" 3 4
                    1
# 79 "../src/audio/widen_ctrl.c"
                        ,
                     0.0f,
                     1.0f,
                     0.0f,
                     
# 83 "../src/audio/widen_ctrl.c" 3 4
                    0
# 83 "../src/audio/widen_ctrl.c"
                         ,
                     0.0f,
                     
# 85 "../src/audio/widen_ctrl.c" 3 4
                    0
# 85 "../src/audio/widen_ctrl.c"
                         ,
                     0.0f);
...
# 90 "../src/audio/widen_ctrl.c" 3 4
                    1
# 90 "../src/audio/widen_ctrl.c"
                        ,
                     0.0f,
                     1.0f,
                     0.0f,
                     
# 94 "../src/audio/widen_ctrl.c" 3 4
                    0
# 94 "../src/audio/widen_ctrl.c"
                         ,
                     0.0f,
                     
# 96 "../src/audio/widen_ctrl.c" 3 4
                    0
# 96 "../src/audio/widen_ctrl.c"
                         ,
                     0.0f);
...
{
    widen_set_params(&g_widen, 
# 106 "../src/audio/widen_ctrl.c" 3 4
                              1
# 106 "../src/audio/widen_ctrl.c"
                                  ,
                     0.0f,
                     1.8f,
                     0.0f,
                     
# 110 "../src/audio/widen_ctrl.c" 3 4
                    1
# 110 "../src/audio/widen_ctrl.c"
                        , 2.3f,
                     
# 111 "../src/audio/widen_ctrl.c" 3 4
                    1
# 111 "../src/audio/widen_ctrl.c"
                        , 0.70f);
    widen_set_params(&g_widen2, 
# 112 "../src/audio/widen_ctrl.c" 3 4
                               1
# 112 "../src/audio/widen_ctrl.c"
                                   ,
                     -2.0f,
                     3.5f,
                     0.0f,
                     
# 116 "../src/audio/widen_ctrl.c" 3 4
                    1
# 116 "../src/audio/widen_ctrl.c"
                        , 7.7f,
                     
# 117 "../src/audio/widen_ctrl.c" 3 4
                    1
# 117 "../src/audio/widen_ctrl.c"
                        , 0.85f);
}
# 137 "../src/audio/widen_ctrl.c"
void app_widen_process(const float* in, float* out)
{

    widen_process(&g_widen, in, out, (32));
    widen_process(&g_widen2, out, out, (32));



}
# 164 "../src/audio/widen_ctrl.c"
...
{
    if (w->side_hpf_hz <= 0.0f) return side;
                 ...
                 int delay_buf_samples )
{
    ...
    w->enabled = 
# 204 "../src/audio/widen_ctrl.c" 3 4
                    0
# 204 "../src/audio/widen_ctrl.c"
                         ;
    w->out_gain = 1.0f;
    w->side_gain = 1.0f;
    w->side_hpf_hz = 0.0f;
    ...
    w->use_delay = 
# 209 "../src/audio/widen_ctrl.c" 3 4
                    0
# 209 "../src/audio/widen_ctrl.c"
                         ;
    w->delay_ms = 0.0f;
    ...
    w->use_allpass = 
# 215 "../src/audio/widen_ctrl.c" 3 4
                    0
# 215 "../src/audio/widen_ctrl.c"
                         ;
    w->ap_a = 0.0f;
...
# 231 "../src/audio/widen_ctrl.c" 3 4
                      _Bool 
# 231 "../src/audio/widen_ctrl.c"
                               enabled,
                       float out_gain_db,
                       float side_gain,
                       float side_hpf_hz,
                       
# 235 "../src/audio/widen_ctrl.c" 3 4
                      _Bool 
# 235 "../src/audio/widen_ctrl.c"
                               use_delay,
                       float delay_ms,
                       
# 237 "../src/audio/widen_ctrl.c" 3 4
                      _Bool 
# 237 "../src/audio/widen_ctrl.c"
                               use_allpass,
                       float ap_a )
{
    w->enabled = enabled;
    ...
    if (side_hpf_hz > 0.0f) {
        float alpha = expf(-2.0f * (float)
# 249 "../src/audio/widen_ctrl.c" 3 4
                                         3.14159265358979323846 
# 249 "../src/audio/widen_ctrl.c"
                                              * side_hpf_hz / sample_rate);
    ...
    if (w->use_delay) {
        ...
        w->delay_ms = 1000.0f * ((float)d / sample_rate);
    }
