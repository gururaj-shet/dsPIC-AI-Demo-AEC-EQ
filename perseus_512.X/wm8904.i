...
void wm8904_init( void )
{
    ...
    {
        printf(" Error!! Failed to read WM8904 device ID. Halt!!\n");
        while(1);
    }
...
# 163 "../src/wm8904.c" 3 4
   I2C2STAT1 
# 163 "../src/wm8904.c"
             = 0;
    
# 164 "../src/wm8904.c" 3 4
   I2C2STAT2 
# 164 "../src/wm8904.c"
             = 0;
    ...
    if( !I2Cx_WriteByte(2,(0x34)) )
    {
        return;
    }
    if( !I2Cx_WriteByte(2,uc_register_address) )
    {
        return;
    }


    if( !I2Cx_WriteByte(2,(us_data & 0xFF00)>>8) )
    {
        return;
    }

    if( !I2Cx_WriteByte(2,(us_data & 0x00FF)>>0))
    {
        return;
    }
    ...
    default:
        ...
        if( us_data != read_dat )
        {
            printf(" wm8904_write_reg(): unmatch!! [reg:0x%x] w_data=0x%04x r_dat=0x%04x\n",
...
# 234 "../src/wm8904.c" 3 4
   I2C2STAT1 
# 234 "../src/wm8904.c"
             = 0;
    
# 235 "../src/wm8904.c" 3 4
   I2C2STAT2 
# 235 "../src/wm8904.c"
             = 0;
...
# 258 "../src/wm8904.c" 3 4
   I2C2STAT1 
# 258 "../src/wm8904.c"
             = 0;
    
# 259 "../src/wm8904.c" 3 4
   I2C2STAT2 
# 259 "../src/wm8904.c"
             = 0;
    ...
    I2C2CON1bits.RCEN = 1;
    while (!I2C2STAT1bits.RBF);
    uc_data[0] = 
# 277 "../src/wm8904.c" 3 4
                I2C2RCV
# 277 "../src/wm8904.c"
                       ;
    I2Cx_SendACK(2,
# 278 "../src/wm8904.c" 3 4
   1
# 278 "../src/wm8904.c"
   );
    ...
    while (!I2C2STAT1bits.RBF);
    uc_data[1] = 
# 282 "../src/wm8904.c" 3 4
                I2C2RCV
# 282 "../src/wm8904.c"
                       ;
    I2Cx_SendACK(2,
# 283 "../src/wm8904.c" 3 4
   0
# 283 "../src/wm8904.c"
   );
           ...
           wm8904_confirm_device_id(void)
{
    ...
    data = wm8904_read_reg(0x00);
    if(data != 0x8904)
    {
        printf(" wm8904_confirm_device_id(): Error!! Failed to read WM8904 device ID. Halt!!\n");
        return 
# 302 "../src/wm8904.c" 3 4
              0
# 302 "../src/wm8904.c"
                   ;
    }
    ...
    {
        printf(" wm8904_confirm_device_id(): WM8904 dev ID is 0x8904(good)\n");
        return 
# 307 "../src/wm8904.c" 3 4
              1
# 307 "../src/wm8904.c"
                  ;
    }
...
static void wm8904_config_master(void)
{
    ...
    wm8904_write_reg( 0x04, (0x000C & ((2) << 2)));
    wm8904_write_reg( 0x05, 0x0040 | (0x0006 & ((3) << 1)) | 0x0001 );
    delay_ms(5);

    wm8904_write_reg( 0x05, 0x0040 | (0x0006 & ((1) << 1)) | 0x0001 );
    wm8904_write_reg( 0x04, (0x000C & ((2) << 2)) | 0x0001 );
    wm8904_write_reg( 0x0C, 0x0002 | 0x0001 );
    wm8904_write_reg( 0x0E, 0x0002 | 0x0001 );
    wm8904_write_reg( 0x21, (0x0006 & ((0) << 1)) );
    wm8904_write_reg( 0x3D, 0x0000);
    wm8904_write_reg( 0x62, 0x0001);
    wm8904_write_reg( 0x68, 0x0001);


    wm8904_write_reg( 0x12, 0x0008 | 0x0004 | 0x0002 | 0x0001);
# 379 "../src/wm8904.c"
    wm8904_write_reg( 0x74, 0x0000);
# 395 "../src/wm8904.c"
    wm8904_write_reg( 0x75, (0x3F00 & ((0x7) << 8))| (0x0007 & ((0x4) << 0)));
    wm8904_write_reg( 0x77, (0x7FE0 & ((187) << 5)));
    wm8904_write_reg( 0x76, (0xFFFF & ((32768) << 0)));

    wm8904_write_reg( 0x74, 0x0004);
    delay_ms(5);
    wm8904_write_reg( 0x74, 0x0004 | 0x0001);
    delay_ms(20);
    ...
    wm8904_write_reg( 0x15, (0x3C00 & ((0x3) << 10)) | (0x0007 & ((0x5) << 0)));
    wm8904_write_reg( 0x14, 0x0000);
    ...
    wm8904_write_reg( 0x16, 0x0004 | 0x0002);




    wm8904_write_reg(0x19, 0x0040 | (0x000C & ((3) << 2)) | (0x0003 & ((3) << 0)));

    wm8904_write_reg(0x1A, (0x001F & ((0x0) << 0)));




    wm8904_write_reg( 0x1B, 0x0800 | (0x07FF & ((256) << 0)));
# 454 "../src/wm8904.c"
    wm8904_write_reg(0x2C, (0x001F & ((0x8) << 0)));
    wm8904_write_reg(0x2D, (0x001F & ((0x8) << 0)));
    ...
    wm8904_write_reg(0x2E, (0x0003 & ((0) << 0)) | (0x0030 & ((1) << 4)));
    wm8904_write_reg(0x2F, (0x0003 & ((0) << 0)) | (0x0030 & ((1) << 4)));



    wm8904_write_reg(0x5A, 0x0010 | 0x0001);
    wm8904_write_reg(0x5A, 0x0020 | 0x0010 | 0x0002 | 0x0001);
    wm8904_write_reg(0x43, 0x0008 | 0x0004 | 0x0002 | 0x0001);
    wm8904_write_reg(0x44, 0x0080 | 0x0040 | 0x0020 | 0x0010);
    delay_ms(100);

    wm8904_write_reg(0x5A, 0x0040 | 0x0020 | 0x0010 | 0x0004 | 0x0002 | 0x0001);
    wm8904_write_reg(0x5A, 0x0080 | 0x0040 | 0x0020 | 0x0010 |
                                                    0x0008 | 0x0004 | 0x0002 | 0x0001);


    wm8904_write_reg(0x39, 0x0080 | (0x003F & ((57+6) << 0)));
    wm8904_write_reg(0x3A, 0x0080 | (0x003F & ((57+6) << 0)));
...
# 539 "../src/wm8904.c"
    ...
    wm8904_write_reg(0x19, 0x0040
                                                  | (0x000C & ((3) << 2))
                                                  | (0x0003 & ((2) << 0))
                                               );
# 574 "../src/wm8904.c"
    wm8904_write_reg(0x1A, (0x001F & ((0x04) << 0)));
