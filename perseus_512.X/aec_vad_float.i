...
# 16 "../src/audio/aec_vad_float.c" 2
...
float y1f(float);
float ynf(int, float);
# 18 "../src/audio/aec_vad_float.c" 2
...
# 19 "../src/audio/aec_vad_float.c" 2
...
# 20 "../src/audio/aec_vad_float.c" 2
...
static const float NOISE_SMOOTH_UP = 0.05f;
static const float NOISE_SMOOTH_DOWN = 0.15f;
# 48 "../src/audio/aec_vad_float.c"
void vad_init(vad_state_t* state)
{
    memset(state, 0, sizeof(vad_state_t));

    state->first_frame = 
# 52 "../src/audio/aec_vad_float.c" 3 4
                        1
# 52 "../src/audio/aec_vad_float.c"
                            ;
    state->is_speech = 
# 53 "../src/audio/aec_vad_float.c" 3 4
                      0
# 53 "../src/audio/aec_vad_float.c"
                           ;
...
# 123 "../src/audio/aec_vad_float.c" 3 4
   _Bool 
# 123 "../src/audio/aec_vad_float.c"
        speech_detected;
    ...
    if (state->first_frame)
    {
        ...
        state->first_frame = 
# 135 "../src/audio/aec_vad_float.c" 3 4
                            0
# 135 "../src/audio/aec_vad_float.c"
                                 ;
        state->is_speech = 
# 136 "../src/audio/aec_vad_float.c" 3 4
                          0
# 136 "../src/audio/aec_vad_float.c"
                               ;
        return VAD_SILENCE;
    }
    ...
    if (state->frame_count < 12)
    {
        ...
        state->is_speech = 
# 145 "../src/audio/aec_vad_float.c" 3 4
                          0
# 145 "../src/audio/aec_vad_float.c"
                               ;
        return VAD_SILENCE;
    }
    ...
    {
        speech_detected = 
# 159 "../src/audio/aec_vad_float.c" 3 4
                         0
# 159 "../src/audio/aec_vad_float.c"
                              ;
        state->update_noise = 
# 160 "../src/audio/aec_vad_float.c" 3 4
                             1
# 160 "../src/audio/aec_vad_float.c"
                                 ;
    }
    ...
    if (speech_detected)
    {
        state->hangover_count = 6;
        state->is_speech = 
# 167 "../src/audio/aec_vad_float.c" 3 4
                          1
# 167 "../src/audio/aec_vad_float.c"
                              ;
        state->update_noise = 
# 168 "../src/audio/aec_vad_float.c" 3 4
                             0
# 168 "../src/audio/aec_vad_float.c"
                                  ;
    }
    else
    {
        if (state->hangover_count > 0)
        {
            ...
            state->is_speech = 
# 175 "../src/audio/aec_vad_float.c" 3 4
                              1
# 175 "../src/audio/aec_vad_float.c"
                                  ;
        }
        else
        {
            state->is_speech = 
# 179 "../src/audio/aec_vad_float.c" 3 4
                              0
# 179 "../src/audio/aec_vad_float.c"
                                   ;
            state->update_noise = 
# 180 "../src/audio/aec_vad_float.c" 3 4
                                 1
# 180 "../src/audio/aec_vad_float.c"
                                     ;
        }
    }
...
# 221 "../src/audio/aec_vad_float.c" 3 4
_Bool 
# 221 "../src/audio/aec_vad_float.c"
    vad_inhibit_adaptation(const vad_state_t* state)
{
