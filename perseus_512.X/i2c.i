...
# 306 "../src/i2c.c"
    ...
    {
        if( (GetTicks() > start+(5)) || pI2CxSTAT2bits(inst)->ERR )
        {
            printf("I2Cx_Start(%d): TOUT2!!\n", inst);
            I2Cx_Stop(inst);
            return 
# 320 "../src/i2c.c" 3 4
                  0
...
void I2Cx_SendACK(uint8_t inst, 
# 350 "../src/i2c.c" 3 4
                               _Bool 
# 350 "../src/i2c.c"
                                    ack)
    ...
    I2Cx_WriteByte(uint8_t inst, uint8_t data)
{
    ...
    {
        if( (GetTicks() > start+5) || pI2CxSTAT2bits(2)->ERR )
        {
            printf("I2Cx_WriteByte(%d): TOUT1!!\n", inst);
            I2Cx_Stop(2);
            return 
# 387 "../src/i2c.c" 3 4
                  0
...
uint8_t I2Cx_ReadByte(uint8_t inst, 
# 444 "../src/i2c.c" 3 4
                                   _Bool 
# 444 "../src/i2c.c"
                                        ack)
...
{
# 560 "../src/i2c.c"
    *pI2CxCON1(inst) = 0x00001000;
    *pI2CxCON2(inst) = 0x00000001;
