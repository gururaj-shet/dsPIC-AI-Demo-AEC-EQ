...
# 37 "c:\\program files\\microchip\\xc-dsc\\v3.31\\support\\generic\\h\\builtins_32.h" 3 4
...
# 12 "../src/eq_lib/eq_api_33AK.c" 2
# 1 "c:\\program files\\microchip\\xc-dsc\\v3.31\\include\\math.h" 1 3 4
# 9 "c:\\program files\\microchip\\xc-dsc\\v3.31\\include\\math.h" 3 4
# 1 "c:\\program files\\microchip\\xc-dsc\\v3.31\\include\\features.h" 1 3 4
# 10 "c:\\program files\\microchip\\xc-dsc\\v3.31\\include\\math.h" 2 3 4
...
# 14 "../src/eq_lib/eq_api_33AK.c" 2
# 27 "../src/eq_lib/eq_api_33AK.c"

# 27 "../src/eq_lib/eq_api_33AK.c"
static const float EQ_DEFAULT_FREQ[8] = {
    32.0f,
    62.5f,
    125.0f,
    250.0f,
                                       ...
                                       float sample_rate)
{
    ...
    w0 = 2.0f * 
# 80 "../src/eq_lib/eq_api_33AK.c" 3 4
               3.14159265358979323846 
# 80 "../src/eq_lib/eq_api_33AK.c"
                    * center_freq / sample_rate;


    sin_w0 = 
# 83 "../src/eq_lib/eq_api_33AK.c" 3 4
            __builtin_sinf
# 83 "../src/eq_lib/eq_api_33AK.c"
                (w0);
    cos_w0 = 
# 84 "../src/eq_lib/eq_api_33AK.c" 3 4
            __builtin_cosf
# 84 "../src/eq_lib/eq_api_33AK.c"
                (w0);
...
int EQ_Init(eq_instance_t *eq, float sample_rate)
{
    ...
    if (eq == 
# 197 "../src/eq_lib/eq_api_33AK.c" 3 4
             ((void*)0) 
# 197 "../src/eq_lib/eq_api_33AK.c"
                  || sample_rate <= 0.0f)
    {
        return -1;
    }
    ...
    eq->enabled = 
# 213 "../src/eq_lib/eq_api_33AK.c" 3 4
                 1
# 213 "../src/eq_lib/eq_api_33AK.c"
                     ;
    ...
    for (i = 0; i < 8; i++)
    {
        ...
        eq->band_params[i].bandwidth_oct = 1.0f;
        eq->band_params[i].gain_dB = 0.0f;
...
void EQ_ProcessSeparate(eq_instance_t *eq, const float *input, float *output, int num_samples)
{
    ...
    if (eq == 
# 250 "../src/eq_lib/eq_api_33AK.c" 3 4
             ((void*)0) 
# 250 "../src/eq_lib/eq_api_33AK.c"
                  || input == 
# 250 "../src/eq_lib/eq_api_33AK.c" 3 4
                              ((void*)0) 
# 250 "../src/eq_lib/eq_api_33AK.c"
...
# 250 "../src/eq_lib/eq_api_33AK.c"
    ...
    src = input;
    dst = (num_samples <= 80) ? temp_buf : output;
...
{
    if (eq == 
# 321 "../src/eq_lib/eq_api_33AK.c" 3 4
             ((void*)0) 
# 321 "../src/eq_lib/eq_api_33AK.c"
                  || band < 0 || band >= 8)
    {
        return;
    }
...
{
    if (eq == 
# 349 "../src/eq_lib/eq_api_33AK.c" 3 4
             ((void*)0) 
# 349 "../src/eq_lib/eq_api_33AK.c"
                  || band < 0 || band >= 8)
    {
        return 0.0f;
    }
...
void EQ_SetAllGains(eq_instance_t *eq, const float *gains)
{
    ...
    if (eq == 
# 361 "../src/eq_lib/eq_api_33AK.c" 3 4
             ((void*)0) 
# 361 "../src/eq_lib/eq_api_33AK.c"
                  || gains == 
# 361 "../src/eq_lib/eq_api_33AK.c" 3 4
                              ((void*)0)
# 361 "../src/eq_lib/eq_api_33AK.c"
...
void EQ_GetAllGains(eq_instance_t *eq, float *gains)
{
    ...
    if (eq == 
# 376 "../src/eq_lib/eq_api_33AK.c" 3 4
             ((void*)0) 
# 376 "../src/eq_lib/eq_api_33AK.c"
                  || gains == 
# 376 "../src/eq_lib/eq_api_33AK.c" 3 4
                              ((void*)0)
# 376 "../src/eq_lib/eq_api_33AK.c"
...
{
    if (eq == 
# 389 "../src/eq_lib/eq_api_33AK.c" 3 4
             ((void*)0)
# 389 "../src/eq_lib/eq_api_33AK.c"
                 )
    {
        return;
    }
...
{
    if (eq == 
# 410 "../src/eq_lib/eq_api_33AK.c" 3 4
             ((void*)0)
# 410 "../src/eq_lib/eq_api_33AK.c"
                 )
    {
        return 0.0f;
    }
...
void EQ_Enable(eq_instance_t *eq, 
# 418 "../src/eq_lib/eq_api_33AK.c" 3 4
                                 _Bool 
# 418 "../src/eq_lib/eq_api_33AK.c"
                                      enable)
{
    if (eq != 
# 420 "../src/eq_lib/eq_api_33AK.c" 3 4
             ((void*)0)
# 420 "../src/eq_lib/eq_api_33AK.c"
                 )
    {
        eq->enabled = enable;
    }
...
# 426 "../src/eq_lib/eq_api_33AK.c" 3 4
_Bool 
# 426 "../src/eq_lib/eq_api_33AK.c"
    EQ_IsEnabled(eq_instance_t *eq)
{
    if (eq == 
# 428 "../src/eq_lib/eq_api_33AK.c" 3 4
             ((void*)0)
# 428 "../src/eq_lib/eq_api_33AK.c"
                 )
    {
        return 
# 430 "../src/eq_lib/eq_api_33AK.c" 3 4
              0
# 430 "../src/eq_lib/eq_api_33AK.c"
                   ;
    }
...
void EQ_Reset(eq_instance_t *eq)
{
    ...
    if (eq == 
# 440 "../src/eq_lib/eq_api_33AK.c" 3 4
             ((void*)0)
# 440 "../src/eq_lib/eq_api_33AK.c"
                 )
    {
        return;
    }
                      ...
                      float bandwidth_oct, float gain_dB)
{
    ...
    if (eq == 
# 458 "../src/eq_lib/eq_api_33AK.c" 3 4
             ((void*)0) 
# 458 "../src/eq_lib/eq_api_33AK.c"
                  || band < 0 || band >= 8)
    {
        return;
    }
    ...
    Q = 
# 471 "../src/eq_lib/eq_api_33AK.c" 3 4
       __builtin_sqrtf
# 471 "../src/eq_lib/eq_api_33AK.c"
            (bw_factor) / (bw_factor - 1.0f);
...
void EQ_ProcessQ15(eq_instance_t *eq, int16_t *samples, int num_samples)
{
    ...
    if (eq == 
# 491 "../src/eq_lib/eq_api_33AK.c" 3 4
             ((void*)0) 
# 491 "../src/eq_lib/eq_api_33AK.c"
                  || samples == 
# 491 "../src/eq_lib/eq_api_33AK.c" 3 4
                                ((void*)0) 
# 491 "../src/eq_lib/eq_api_33AK.c"
    ...
    while (num_samples > 0)
    {
        process_count = (num_samples > 80) ? 80 : num_samples;
...
void EQ_SetGainsLegacy(eq_instance_t *eq, const char *gains)
{
    ...
    if (eq == 
# 539 "../src/eq_lib/eq_api_33AK.c" 3 4
             ((void*)0) 
# 539 "../src/eq_lib/eq_api_33AK.c"
                  || gains == 
# 539 "../src/eq_lib/eq_api_33AK.c" 3 4
                              ((void*)0)
# 539 "../src/eq_lib/eq_api_33AK.c"
...
void EQ_GetGainsLegacy(eq_instance_t *eq, char *gains)
{
    ...
    if (eq == 
# 557 "../src/eq_lib/eq_api_33AK.c" 3 4
             ((void*)0) 
# 557 "../src/eq_lib/eq_api_33AK.c"
                  || gains == 
# 557 "../src/eq_lib/eq_api_33AK.c" 3 4
                              ((void*)0)
# 557 "../src/eq_lib/eq_api_33AK.c"
...
{
    if (eq == 
# 576 "../src/eq_lib/eq_api_33AK.c" 3 4
             ((void*)0)
# 576 "../src/eq_lib/eq_api_33AK.c"
                 )
    {
        return;
    }
...
{
    if (eq == 
# 586 "../src/eq_lib/eq_api_33AK.c" 3 4
             ((void*)0)
# 586 "../src/eq_lib/eq_api_33AK.c"
                 )
    {
        return 0;
    }
