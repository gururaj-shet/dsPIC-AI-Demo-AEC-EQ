...
void SST26_test(void)
{
    ...
    else
    {
        ...
        {
            if( (cnt+(256)) <= NOTIF_ACTION_WAV_SIZE )
            {
                printf("sst26_page_program: addr=0x%08lx size=%d\n", cnt, (256));
                sst26_page_program(cnt, &p_data[cnt], (256));
                cnt += (256);
            }
            else
            {
    ...
    sst26_read_jedec_id(void)
{
    ...
    if(mfr==(0xBF) && dev_typ==(0x26) && dev_id==(0x12)) {
        printf("(good)\n");
        return 
# 162 "../src/SST26_drv.c" 3 4
              1
# 162 "../src/SST26_drv.c"
                  ;
    } else {
    ...
    sst26_verify(uint32_t addr, const uint8_t *data, size_t len)
{
    ...
    for (size_t i=0; i<len; i++) {
        ...
        spi3_CS_deassert();
        if (r != data[i]) return 
# 248 "../src/SST26_drv.c" 3 4
                                0
# 248 "../src/SST26_drv.c"
                                     ;
    }
    return 
# 250 "../src/SST26_drv.c" 3 4
          1
# 250 "../src/SST26_drv.c"
              ;
}
