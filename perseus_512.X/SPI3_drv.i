...
# 171 "../src/SPI3_drv.c" 3 4
   RPINR16bits.SDI3R 
# 171 "../src/SPI3_drv.c"
                      = (14);
    
# 172 "../src/SPI3_drv.c" 3 4
   RPOR3bits.RP13R 
# 172 "../src/SPI3_drv.c"
                      = (31);
    
# 173 "../src/SPI3_drv.c" 3 4
   RPOR16bits.RP66R 
# 173 "../src/SPI3_drv.c"
                      = (32);
...
# 176 "../src/SPI3_drv.c" 3 4
   SPI3CON1 
# 176 "../src/SPI3_drv.c"
            = 0;
    
# 177 "../src/SPI3_drv.c" 3 4
   SPI3STAT 
# 177 "../src/SPI3_drv.c"
            = 0;
...
# 194 "../src/SPI3_drv.c" 3 4
   SPI3BRG 
# 194 "../src/SPI3_drv.c"
           = ((uint16_t)(((100000000UL)/(2UL*(12500000UL))) - 1UL));

    (void)
# 196 "../src/SPI3_drv.c" 3 4
         SPI3BUF
# 196 "../src/SPI3_drv.c"
                ;
    SPI3STATbits.SPIROV = 0;
    
# 198 "../src/SPI3_drv.c" 3 4
   IFS2bits.SPI3RXIF 
# 198 "../src/SPI3_drv.c"
             = 0;
    
# 199 "../src/SPI3_drv.c" 3 4
   IFS2bits.SPI3TXIF 
# 199 "../src/SPI3_drv.c"
             = 0;
...
# 212 "../src/SPI3_drv.c" 3 4
                             LATDbits.LATD15 
# 212 "../src/SPI3_drv.c"
                             = 0); }
void spi3_CS_deassert(void) { (
# 213 "../src/SPI3_drv.c" 3 4
                             LATDbits.LATD15 
# 213 "../src/SPI3_drv.c"
                             = 1); }
...
{
    spi3_wait_tx_not_full();
    
# 250 "../src/SPI3_drv.c" 3 4
   SPI3BUF 
# 250 "../src/SPI3_drv.c"
           = v;
    spi3_wait_rx_full();
    return (uint8_t)
# 252 "../src/SPI3_drv.c" 3 4
                   SPI3BUF
# 252 "../src/SPI3_drv.c"
                          ;
}
...
# 339 "../src/SPI3_drv.c"
    (
# 339 "../src/SPI3_drv.c" 3 4
   ANSELA 
# 339 "../src/SPI3_drv.c"
   &= ~(1u << (12)));
    (
# 340 "../src/SPI3_drv.c" 3 4
   TRISAbits.TRISA12 
# 340 "../src/SPI3_drv.c"
   = 0);

    (
# 342 "../src/SPI3_drv.c" 3 4
   ANSELA 
# 342 "../src/SPI3_drv.c"
   &= ~(1u << (13)));
    (
# 343 "../src/SPI3_drv.c" 3 4
   TRISAbits.TRISA13 
# 343 "../src/SPI3_drv.c"
   = 0);

    (
# 345 "../src/SPI3_drv.c" 3 4
   ANSELE 
# 345 "../src/SPI3_drv.c"
   &= ~(1u << (1)));
    (
# 346 "../src/SPI3_drv.c" 3 4
   TRISEbits.TRISE1 
# 346 "../src/SPI3_drv.c"
   = 0);

    (
# 348 "../src/SPI3_drv.c" 3 4
   ANSELD 
# 348 "../src/SPI3_drv.c"
   &= ~(1u << (15)));
    (
# 349 "../src/SPI3_drv.c" 3 4
   TRISDbits.TRISD15 
# 349 "../src/SPI3_drv.c"
   = 0);

    (
# 351 "../src/SPI3_drv.c" 3 4
   ANSELE 
# 351 "../src/SPI3_drv.c"
   &= ~(1u << (3)));
    (
# 352 "../src/SPI3_drv.c" 3 4
   TRISEbits.TRISE3 
# 352 "../src/SPI3_drv.c"
   = 0);

    (
# 354 "../src/SPI3_drv.c" 3 4
   ANSELE 
# 354 "../src/SPI3_drv.c"
   &= ~(1u << (0)));
    (
# 355 "../src/SPI3_drv.c" 3 4
   TRISEbits.TRISE0 
# 355 "../src/SPI3_drv.c"
   = 0);
    ...
    (
# 358 "../src/SPI3_drv.c" 3 4
   LATEbits.LATE0 
# 358 "../src/SPI3_drv.c"
   = 0);
    delay_ms(1);
    (
# 360 "../src/SPI3_drv.c" 3 4
   LATEbits.LATE0 
# 360 "../src/SPI3_drv.c"
   = 1);
    (
# 361 "../src/SPI3_drv.c" 3 4
   LATEbits.LATE3 
# 361 "../src/SPI3_drv.c"
   = 1);
