...
# 60 "../src/adc/adc4.c"
static int32_t Iadc4_Data[ (2) * (32) ] __attribute__((aligned(4)));

extern int _CompileAssert[((((2) * (32))/2) == ((sizeof(Iadc4_Data) / sizeof((Iadc4_Data)[0]))/2))?1:-1];
...
# 109 "../src/adc/adc4.c" 3 4
   IFS2bits.DMA3IF 
# 109 "../src/adc/adc4.c"
            = 0;
    dma_stat = 
# 110 "../src/adc/adc4.c" 3 4
              DMA3STAT
# 110 "../src/adc/adc4.c"
                      ;
    
# 111 "../src/adc/adc4.c" 3 4
   DMA3STAT 
# 111 "../src/adc/adc4.c"
            = 0;
# 123 "../src/adc/adc4.c"
    if(dma_stat & 
# 123 "../src/adc/adc4.c" 3 4
                 0x00000010
# 123 "../src/adc/adc4.c"
                                    )
    {
...
# 131 "../src/adc/adc4.c"
    ...
    ADC3_Cpy_Tdm_Style( idx_tdm, (2), 1 , &Iadc4_Data[idx_adc] );
}
# 155 "../src/adc/adc4.c"
static void dma3_config(void)
{
...
# 165 "../src/adc/adc4.c" 3 4
   DMA3DST 
# 165 "../src/adc/adc4.c"
           = (uint32_t)&Iadc4_Data;
    
# 166 "../src/adc/adc4.c" 3 4
   DMA3CNT 
# 166 "../src/adc/adc4.c"
           = (sizeof(Iadc4_Data) / sizeof((Iadc4_Data)[0]));
    ...
    DMA3CHbits.RELOADC = 1;
    DMA3CHbits.RELOADS = 0;
    DMA3CHbits.RELOADD = 1;
...
# 195 "../src/adc/adc4.c" 3 4
   IPC10bits.DMA3IP 
# 195 "../src/adc/adc4.c"
           = 4;
    
# 196 "../src/adc/adc4.c" 3 4
   IFS2bits.DMA3IF 
# 196 "../src/adc/adc4.c"
           = 0;
    
# 197 "../src/adc/adc4.c" 3 4
   IEC2bits.DMA3IE 
# 197 "../src/adc/adc4.c"
           = 1;
...
# 223 "../src/adc/adc4.c" 3 4
   AD4CON 
# 223 "../src/adc/adc4.c"
               = 0x0UL;
    
# 224 "../src/adc/adc4.c" 3 4
   AD4DATAOVR 
# 224 "../src/adc/adc4.c"
               = 0x0UL;
    
# 225 "../src/adc/adc4.c" 3 4
   AD4STAT 
# 225 "../src/adc/adc4.c"
               = 0x0UL;
    
# 226 "../src/adc/adc4.c" 3 4
   AD4RSTAT 
# 226 "../src/adc/adc4.c"
               = 0x0UL;
    
# 227 "../src/adc/adc4.c" 3 4
   AD4CMPSTAT 
# 227 "../src/adc/adc4.c"
               = 0x0UL;
    
# 228 "../src/adc/adc4.c" 3 4
   AD4SWTRG 
# 228 "../src/adc/adc4.c"
               = 0x0UL;
# 237 "../src/adc/adc4.c"
    
# 237 "../src/adc/adc4.c" 3 4
   RPINR23bits.ADTRG31R 
# 237 "../src/adc/adc4.c"
             = 70;

    (
# 239 "../src/adc/adc4.c" 3 4
   ANSELB 
# 239 "../src/adc/adc4.c"
   |= (1u << (5)));
    (
# 240 "../src/adc/adc4.c" 3 4
   TRISBbits.TRISB5 
# 240 "../src/adc/adc4.c"
   = 1);
    AD4CH0CON1bits.PINSEL = 5;



    AD4CH0CON1bits.DIFF = 0;
    AD4CH0CON1bits.NINSEL = 0;
    AD4CH0CON1bits.FRAC = 0;
    AD4CH0CON1bits.TRG1POL = 0;
    AD4CH0CON1bits.EIEN = 0;
    AD4CH0CON1bits.IRQSEL = 1;
    AD4CH0CON1bits.SAMC = 0;
    AD4CH0CON1bits.ACCNUM = 3;
    AD4CH0CON1bits.MODE = 3;
    AD4CH0CON1bits.TRG1SRC = 0b011111;
    ...
    AD4CH0CON1bits.TRG2SRC = 3;
    AD4CONbits.RPTCNT = 8;



    AD4CH0CON2bits.ACCRO = 0;
    AD4CH0CON2bits.ACCBRST = 1;
    AD4CH0CON2bits.CMPVAL = 1;
    AD4CH0CON2bits.CMPCNTMOD = 0;

    AD4CH0CON2bits.CMPMOD = 0;
    AD4CH0CON2bits.ADCMPCNT = 0;





    AD4CONbits.ACALEN = 0x0UL;
...
# 294 "../src/adc/adc4.c" 3 4
   IFS6bits.AD4CH0IF 
# 294 "../src/adc/adc4.c"
             = 0;
    
# 295 "../src/adc/adc4.c" 3 4
   IEC6bits.AD4CH0IE 
# 295 "../src/adc/adc4.c"
             = 0;
...
# 302 "../src/adc/adc4.c" 3 4
   AD4CON 
# 302 "../src/adc/adc4.c"
               = 0x0UL;
    
# 303 "../src/adc/adc4.c" 3 4
   AD4DATAOVR 
# 303 "../src/adc/adc4.c"
               = 0x0UL;
    
# 304 "../src/adc/adc4.c" 3 4
   AD4STAT 
# 304 "../src/adc/adc4.c"
               = 0x0UL;
    
# 305 "../src/adc/adc4.c" 3 4
   AD4RSTAT 
# 305 "../src/adc/adc4.c"
               = 0x0UL;
    
# 306 "../src/adc/adc4.c" 3 4
   AD4CMPSTAT 
# 306 "../src/adc/adc4.c"
               = 0x0UL;
    
# 307 "../src/adc/adc4.c" 3 4
   AD4SWTRG 
# 307 "../src/adc/adc4.c"
               = 0x0UL;

    
# 309 "../src/adc/adc4.c" 3 4
   AD4CH0CON1 
# 309 "../src/adc/adc4.c"
               = 0x0UL;
    
# 310 "../src/adc/adc4.c" 3 4
   AD4CH1CON1 
# 310 "../src/adc/adc4.c"
               = 0x0UL;
    
# 311 "../src/adc/adc4.c" 3 4
   AD4CH2CON1 
# 311 "../src/adc/adc4.c"
               = 0x0UL;
    
# 312 "../src/adc/adc4.c" 3 4
   AD4CH3CON1 
# 312 "../src/adc/adc4.c"
               = 0x0UL;
    
# 313 "../src/adc/adc4.c" 3 4
   AD4CH4CON1 
# 313 "../src/adc/adc4.c"
               = 0x0UL;
    
# 314 "../src/adc/adc4.c" 3 4
   AD4CH5CON1 
# 314 "../src/adc/adc4.c"
               = 0x0UL;
    
# 315 "../src/adc/adc4.c" 3 4
   AD4CH6CON1 
# 315 "../src/adc/adc4.c"
               = 0x0UL;
    
# 316 "../src/adc/adc4.c" 3 4
   AD4CH7CON1 
# 316 "../src/adc/adc4.c"
               = 0x0UL;

    
# 318 "../src/adc/adc4.c" 3 4
   AD4CH0CON2 
# 318 "../src/adc/adc4.c"
               = 0x0UL;
    
# 319 "../src/adc/adc4.c" 3 4
   AD4CH1CON2 
# 319 "../src/adc/adc4.c"
               = 0x0UL;
    
# 320 "../src/adc/adc4.c" 3 4
   AD4CH2CON2 
# 320 "../src/adc/adc4.c"
               = 0x0UL;
    
# 321 "../src/adc/adc4.c" 3 4
   AD4CH3CON2 
# 321 "../src/adc/adc4.c"
               = 0x0UL;
    
# 322 "../src/adc/adc4.c" 3 4
   AD4CH4CON2 
# 322 "../src/adc/adc4.c"
               = 0x0UL;
    
# 323 "../src/adc/adc4.c" 3 4
   AD4CH5CON2 
# 323 "../src/adc/adc4.c"
               = 0x0UL;
    
# 324 "../src/adc/adc4.c" 3 4
   AD4CH6CON2 
# 324 "../src/adc/adc4.c"
               = 0x0UL;
    
# 325 "../src/adc/adc4.c" 3 4
   AD4CH7CON2 
# 325 "../src/adc/adc4.c"
               = 0x0UL;

    
# 327 "../src/adc/adc4.c" 3 4
   AD4CH0RES 
# 327 "../src/adc/adc4.c"
               = 0x0UL;
    
# 328 "../src/adc/adc4.c" 3 4
   AD4CH1RES 
# 328 "../src/adc/adc4.c"
               = 0x0UL;
    
# 329 "../src/adc/adc4.c" 3 4
   AD4CH2RES 
# 329 "../src/adc/adc4.c"
               = 0x0UL;
    
# 330 "../src/adc/adc4.c" 3 4
   AD4CH3RES 
# 330 "../src/adc/adc4.c"
               = 0x0UL;
    
# 331 "../src/adc/adc4.c" 3 4
   AD4CH4RES 
# 331 "../src/adc/adc4.c"
               = 0x0UL;
    
# 332 "../src/adc/adc4.c" 3 4
   AD4CH5RES 
# 332 "../src/adc/adc4.c"
               = 0x0UL;
    
# 333 "../src/adc/adc4.c" 3 4
   AD4CH6RES 
# 333 "../src/adc/adc4.c"
               = 0x0UL;
    
# 334 "../src/adc/adc4.c" 3 4
   AD4CH7RES 
# 334 "../src/adc/adc4.c"
               = 0x0UL;

    
# 336 "../src/adc/adc4.c" 3 4
   AD4CH0CNT 
# 336 "../src/adc/adc4.c"
               = 0x0UL;
    
# 337 "../src/adc/adc4.c" 3 4
   AD4CH1CNT 
# 337 "../src/adc/adc4.c"
               = 0x0UL;
    
# 338 "../src/adc/adc4.c" 3 4
   AD4CH2CNT 
# 338 "../src/adc/adc4.c"
               = 0x0UL;
    
# 339 "../src/adc/adc4.c" 3 4
   AD4CH3CNT 
# 339 "../src/adc/adc4.c"
               = 0x0UL;
    
# 340 "../src/adc/adc4.c" 3 4
   AD4CH4CNT 
# 340 "../src/adc/adc4.c"
               = 0x0UL;
    
# 341 "../src/adc/adc4.c" 3 4
   AD4CH5CNT 
# 341 "../src/adc/adc4.c"
               = 0x0UL;
    
# 342 "../src/adc/adc4.c" 3 4
   AD4CH6CNT 
# 342 "../src/adc/adc4.c"
               = 0x0UL;
    
# 343 "../src/adc/adc4.c" 3 4
   AD4CH7CNT 
# 343 "../src/adc/adc4.c"
               = 0x0UL;

    
# 345 "../src/adc/adc4.c" 3 4
   AD4CH0CMPLO 
# 345 "../src/adc/adc4.c"
               = 0x0UL;
    
# 346 "../src/adc/adc4.c" 3 4
   AD4CH1CMPLO 
# 346 "../src/adc/adc4.c"
               = 0x0UL;
    
# 347 "../src/adc/adc4.c" 3 4
   AD4CH2CMPLO 
# 347 "../src/adc/adc4.c"
               = 0x0UL;
    
# 348 "../src/adc/adc4.c" 3 4
   AD4CH3CMPLO 
# 348 "../src/adc/adc4.c"
               = 0x0UL;
    
# 349 "../src/adc/adc4.c" 3 4
   AD4CH4CMPLO 
# 349 "../src/adc/adc4.c"
               = 0x0UL;
    
# 350 "../src/adc/adc4.c" 3 4
   AD4CH5CMPLO 
# 350 "../src/adc/adc4.c"
               = 0x0UL;
    
# 351 "../src/adc/adc4.c" 3 4
   AD4CH6CMPLO 
# 351 "../src/adc/adc4.c"
               = 0x0UL;
    
# 352 "../src/adc/adc4.c" 3 4
   AD4CH7CMPLO 
# 352 "../src/adc/adc4.c"
               = 0x0UL;

    
# 354 "../src/adc/adc4.c" 3 4
   AD4CH0CMPHI 
# 354 "../src/adc/adc4.c"
               = 0x0UL;
    
# 355 "../src/adc/adc4.c" 3 4
   AD4CH1CMPHI 
# 355 "../src/adc/adc4.c"
               = 0x0UL;
    
# 356 "../src/adc/adc4.c" 3 4
   AD4CH2CMPHI 
# 356 "../src/adc/adc4.c"
               = 0x0UL;
    
# 357 "../src/adc/adc4.c" 3 4
   AD4CH3CMPHI 
# 357 "../src/adc/adc4.c"
               = 0x0UL;
    
# 358 "../src/adc/adc4.c" 3 4
   AD4CH4CMPHI 
# 358 "../src/adc/adc4.c"
               = 0x0UL;
    
# 359 "../src/adc/adc4.c" 3 4
   AD4CH5CMPHI 
# 359 "../src/adc/adc4.c"
               = 0x0UL;
    
# 360 "../src/adc/adc4.c" 3 4
   AD4CH6CMPHI 
# 360 "../src/adc/adc4.c"
               = 0x0UL;
    
# 361 "../src/adc/adc4.c" 3 4
   AD4CH7CMPHI 
# 361 "../src/adc/adc4.c"
               = 0x0UL;
}
